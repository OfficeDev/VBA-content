...
|ConnectionSite|Required| **Long**|A connection site on the shape specified by ConnectedShape. Must be an integer between 1 and the integer returned by the  ** [ConnectionSiteCount](00c32910-96b6-6981-8359-de4a71852934.md)** property of the specified shape. Connection sites are numbered starting from the top of the specified shape and moving counterclockwise around the shape. If you want the connector to automatically find the shortest path between the two shapes it connects, specify any valid integer for this argument and then use the ** [RerouteConnections](04afd4aa-dc84-d39c-e9fa-d06f8f4c0a02.md)**method after the connector is attached to shapes at both ends.|
...
Use the  ** [BeginConnect](d38f6ac7-f09b-b171-a6b8-d52427f45d78.md)** method to attach the beginning of the connector to a shape.
