...
Returns a  [Double](b8bdf64f-5920-1ae9-16d0-b26d09524a30.md) specifying the net present value of an investment based on a series of periodic cash flows (payments and receipts) and a discount rate.
 **Syntax**
 **NPV( _rate_**,  **_values_())**
The  **NPV** function has these [named arguments](b8bdf64f-5920-1ae9-16d0-b26d09524a30.md):
