...
Enables an error-handling routine and specifies the location of the routine within a  [procedure](b8bdf64f-5920-1ae9-16d0-b26d09524a30.md); can also be used to disable an error-handling routine.
...
|:-----|:-----|
| **On Error GoTo**_line_|Enables the error-handling routine that starts at  _line_ specified in the required _line_ [argument](b8bdf64f-5920-1ae9-16d0-b26d09524a30.md). The  _line_ argument is any [line label](b8bdf64f-5920-1ae9-16d0-b26d09524a30.md) or [line number](b8bdf64f-5920-1ae9-16d0-b26d09524a30.md). If a  [run-time error](b8bdf64f-5920-1ae9-16d0-b26d09524a30.md) occurs, control branches to _line_, making the error handler active _._ The specified _line_ must be in the same procedure as the **On Error** statement; otherwise, a [compile-time](b8bdf64f-5920-1ae9-16d0-b26d09524a30.md) error occurs.|
| **On Error Resume Next**|Specifies that when a run-time error occurs, control goes to the  [statement](b8bdf64f-5920-1ae9-16d0-b26d09524a30.md) immediately following the statement where the error occurred where execution continues. Use this form rather than **On Error GoTo** when accessing objects.|
...
Untrapped errors in objects are returned to the controlling application when the object is running as an executable file. Within the development environment, untrapped errors are only returned to the controlling application if the proper options are set. See your  [host application's](b8bdf64f-5920-1ae9-16d0-b26d09524a30.md) documentation for a description of which options should be set during debugging, how to set them, and whether the host can create [classes](b8bdf64f-5920-1ae9-16d0-b26d09524a30.md).
