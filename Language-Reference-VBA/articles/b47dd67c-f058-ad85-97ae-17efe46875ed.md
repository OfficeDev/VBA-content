...
Specifies the default  [run time](b8bdf64f-5920-1ae9-16d0-b26d09524a30.md) mode of the [Input Method Editor (IME](7ce2c60f-29fb-96e2-2516-73c99a6e7cff.md)) for a control. This property applies only to applications written for East Asia and is ignored in other applications.
 **Syntax**
...
The  **fmIMEModeNoControl** setting indicates that the mode of the IME does not change when the control receives [focus](b8bdf64f-5920-1ae9-16d0-b26d09524a30.md) at run time. For any other value, the mode of the IME is set to the value specified by the **IMEMode** property when the control receives focus at run time.
 **Remarks**
