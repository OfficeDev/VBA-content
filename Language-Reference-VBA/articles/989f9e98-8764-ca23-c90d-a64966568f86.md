 ...
 **Column** returns a _Variant_ from the cursor. When a built-in [cursor](7ce2c60f-29fb-96e2-2516-73c99a6e7cff.md) provides the value for _Variant_ (such as when using the **AddItem** method), the value is a string. When an external cursor provides the value for _Variant_, formatting associated with the data is not included in the  _Variant_.
 **Remarks**
...
You can also use  **Column** to copy an entire two-dimensional [array](b8bdf64f-5920-1ae9-16d0-b26d09524a30.md) of values to a control. This syntax lets you quickly load a list of choices rather than individually loading each element of the list using **AddItem**.
