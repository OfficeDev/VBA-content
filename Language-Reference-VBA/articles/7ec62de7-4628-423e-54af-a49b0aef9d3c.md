...
|:-----|:-----|
| **Property Get**| **Property Get**_propname_(1, â€¦,  _n_)  **As**_type_|
| **Property Let**| **Property Let**_propname_(1, â€¦,,,,  _n_,  _n_+1)|
| **Property Set**| **Property Set**_propname_(1, â€¦,  _n_,  _n_+1)|
The first argument through the next to last argument (1, â€¦,  _n_) must share the same names and data types in all  **Property** procedures with the same name.
