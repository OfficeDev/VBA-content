...
- An attempt has been made to call a procedure in a  [dynamic-link library (DLL)](b8bdf64f-5920-1ae9-16d0-b26d09524a30.md), but the library or resource file name specified in the  **Lib** clause of the **Declare** statement can't be found.
    
    Check the spelling of the file name and the path specification.
    
- In the development environment, this error occurs if you attempt to open a  [project](b8bdf64f-5920-1ae9-16d0-b26d09524a30.md) or load a text file that doesn't exist.
