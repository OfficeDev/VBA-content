...
The  **GetObject** function syntax has these [named arguments](b8bdf64f-5920-1ae9-16d0-b26d09524a30.md):
...
| **_class_**|Optional;  **Variant** ( **String**). A string representing the  [class](b8bdf64f-5920-1ae9-16d0-b26d09524a30.md) of the object.|
 ...
 **Remarks**
Use the  **GetObject** function to access an ActiveX object from a file and assign the object to an [object variable](b8bdf64f-5920-1ae9-16d0-b26d09524a30.md). Use the  **Set** statement to assign the object returned by **GetObject** to the object variable. For example:
...
Once an object is activated, you reference it in code using the object variable you defined. In the preceding example, you access  [properties](b8bdf64f-5920-1ae9-16d0-b26d09524a30.md) and [methods](b8bdf64f-5920-1ae9-16d0-b26d09524a30.md) of the new object using the object variable `MyObject`. For example:
