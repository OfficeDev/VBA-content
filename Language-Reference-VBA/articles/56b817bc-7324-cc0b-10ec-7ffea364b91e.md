...
Used at  [procedure level](b8bdf64f-5920-1ae9-16d0-b26d09524a30.md) to declare [variables](b8bdf64f-5920-1ae9-16d0-b26d09524a30.md) and allocate storage space. Variables declared with the **Static** statement retain their values as long as the code is running.
...
| _subscripts_|Optional. Dimensions of an  [array](b8bdf64f-5920-1ae9-16d0-b26d09524a30.md) variable; up to 60 multiple dimensions may be declared. The _subscripts_ [argument](b8bdf64f-5920-1ae9-16d0-b26d09524a30.md) uses the following syntax: [ _lower_**To**]  _upper_ [ **,**[ _lower_**To**]  _upper_]  **. . .** When not explicitly stated in _lower_, the lower bound of an array is controlled by the  **Option** **Base** statement. The lower bound is zero if no **Option** **Base** statement is present.|
| **New**|Optional.  [Keyword](b8bdf64f-5920-1ae9-16d0-b26d09524a30.md) that enables implicit creation of an object. If you use **New** when declaring the [object variable](b8bdf64f-5920-1ae9-16d0-b26d09524a30.md), a new instance of the object is created on first reference to it, so you don't have to use the  **Set** statement to assign the object reference. The **New** keyword can't be used to declare variables of any intrinsic [data type](b8bdf64f-5920-1ae9-16d0-b26d09524a30.md) and can't be used to declare instances of dependent objects.|
 ...
 **Remarks**
Once  [module](b8bdf64f-5920-1ae9-16d0-b26d09524a30.md) code is running, variables declared with the **Static** [statement](b8bdf64f-5920-1ae9-16d0-b26d09524a30.md) retain their value until the module is reset or restarted. In [class modules](b8bdf64f-5920-1ae9-16d0-b26d09524a30.md), variables declared with the  **Static** statement retain their value in each class instance until that instance is destroyed. In [form modules](b8bdf64f-5920-1ae9-16d0-b26d09524a30.md), static variables retain their value until the form is closed. Use the  **Static** statement in nonstatic [procedure](b8bdf64f-5920-1ae9-16d0-b26d09524a30.md)s to explicitly declare variables that are visible only within the procedure, but whose lifetime is the same as the module in which the procedure is defined.
...
If the  **New** keyword isn't used when declaring an object variable, the variable that refers to the object must be assigned an existing object using the **Set** statement before it can be used. Until it is assigned an object, the declared object variable has the special value **Nothing**, which indicates that it doesn't refer to any particular instance of an object. When you use the  **New** keyword in the [declaration](b8bdf64f-5920-1ae9-16d0-b26d09524a30.md), an instance of the object is created on the first reference to the object.
