 ...
 **In this article**
 [Running Statements if a Condition is True](#sectionSection0)
 [Running Certain Statements if a Condition is True and Running Others if It's False](#sectionSection1)
 [Testing a Second Condition if the First Condition is False](#sectionSection2)
