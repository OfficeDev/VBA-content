 ...
 **Remarks**
The  **List** property works with the **ListCount** and **ListIndex** properties.Use **List** to access list items. A list is a variant [array](b8bdf64f-5920-1ae9-16d0-b26d09524a30.md); each item in the list has a row number and a column number.
