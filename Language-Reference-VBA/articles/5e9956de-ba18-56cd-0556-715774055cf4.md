...
Returns a  [Long](b8bdf64f-5920-1ae9-16d0-b26d09524a30.md) whole number representing an RGB color value.
 **Syntax**
 **RGB( _red_,  _green_,  _blue_)**
The  **RGB** function syntax has these [named arguments](b8bdf64f-5920-1ae9-16d0-b26d09524a30.md):
 ...
 **Remarks**
Application  [methods](b8bdf64f-5920-1ae9-16d0-b26d09524a30.md) and [properties](b8bdf64f-5920-1ae9-16d0-b26d09524a30.md) that accept a color specification expect that specification to be a number representing an RGB color value. An RGB color value specifies the relative intensity of red, green, and blue to cause a specific color to be displayed.
The value for any  [argument](b8bdf64f-5920-1ae9-16d0-b26d09524a30.md) to **RGB** that exceeds 255 is assumed to be 255.
