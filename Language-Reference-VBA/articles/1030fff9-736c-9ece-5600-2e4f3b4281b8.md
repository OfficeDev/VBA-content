 ...
 **Remarks**
For a  **MultiPage** control, the **Add** method returns a **Page** object. For a **TabStrip**, it returns a  **Tab** object. The index value for the first **Page** or **Tab** of a [collection](b8bdf64f-5920-1ae9-16d0-b26d09524a30.md) is 0, the value for the second **Page** or **Tab** is 1, and so on.
 ...
 **Note**  You can change a control's  **Name** property at [run time](b8bdf64f-5920-1ae9-16d0-b26d09524a30.md) only if you added that control at run time with the **Add** method.
