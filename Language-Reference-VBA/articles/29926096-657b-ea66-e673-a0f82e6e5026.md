...
-  **No matching** â€” provides no assistance in matching a user's typed entry to an entry in the list.
    
-  **First letter** â€” compares the most recently-typed letter to the first letter of each entry in the list. The first match in the list is selected.
    
-  **Complete** â€” compares the user's entry and tries to find an exact match in an entry from the list.
