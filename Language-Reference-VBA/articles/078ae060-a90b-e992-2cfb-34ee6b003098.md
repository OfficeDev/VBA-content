...
- A  [referenced project](b8bdf64f-5920-1ae9-16d0-b26d09524a30.md) could not be found, or a referenced [object library](b8bdf64f-5920-1ae9-16d0-b26d09524a30.md) corresponding to the language of the [project](b8bdf64f-5920-1ae9-16d0-b26d09524a30.md) could not be found.
...
3. Start the  [Object Browser](b8bdf64f-5920-1ae9-16d0-b26d09524a30.md).
...
To remove a reference that is no longer required, simply clear the check box next to the unnecessary reference. Note that the references to the Visual Basic object library and  [host-application](b8bdf64f-5920-1ae9-16d0-b26d09524a30.md) object library can't be removed.
...
If you can't find a missing project or library on your system, contact the  [referencing project](b8bdf64f-5920-1ae9-16d0-b26d09524a30.md)'s author. If the missing library is a Microsoft application object library, you can obtain it as follows:
