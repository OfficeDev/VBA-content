...
Returns a  [Double](b8bdf64f-5920-1ae9-16d0-b26d09524a30.md) specifying the principal payment for a given period of an annuity based on periodic, fixed payments and a fixed interest rate.
 **Syntax**
 **PPmt( _rate_**,  **_per_**,  **_nper_**,  **_pv_**[,  **_fv_**[,  **_type_**]] **)**
The  **PPmt** function has these [named arguments](b8bdf64f-5920-1ae9-16d0-b26d09524a30.md):
...
| **_per_**|Required.  [Integer](b8bdf64f-5920-1ae9-16d0-b26d09524a30.md) specifying payment period in the range 1 through **_nper_**.|
