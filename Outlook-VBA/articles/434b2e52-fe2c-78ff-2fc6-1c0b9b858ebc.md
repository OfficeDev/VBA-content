...
Returns or sets a  **String** that specifies the width of each column in a multicolumn ** [ComboBox](31e7c1de-ee4e-b3d9-4579-7fc6b215bad3.md)**. Read/write.
...
In a  **ComboBox**, the system displays the column designated by the  ** [TextColumn](5ebf37ef-4cec-ec42-d42f-ab886b86e913.md)** property in the text box portion of the control. Setting **TextColumn** to -1 displays the first column that has a **ColumnWidths** value greater than 0.
