...
Returns or sets a  **Boolean** value that determines if labels for Outlook items are displayed when viewing by month in the ** [TimelineView](fb14c1a1-f542-fa1e-f30f-c5ee3d2f0206.md)** object. Read/write.
...
This property is applicable only if the  ** [TimelineViewMode](597facd9-74c4-266a-329d-c90bc77f8585.md)** property is set to **olTimelineViewMonth**.
