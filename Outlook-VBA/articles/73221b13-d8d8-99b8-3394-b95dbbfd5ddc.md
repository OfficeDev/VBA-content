...
This section of the Outlook VBA reference contains documentation for all of the objects, properties, methods, and events contained in the Outlook object model. You can use the table of contents to navigate through the documentation.
