...
|:-----|:-----|:-----|:-----|
|Binary properties|Supported |Not supported|If you add a binary property to a  **Table** referencing its namespace, the value of the property in the **Table** is in binary. <br>
You can use **[Row.BinaryToString](2416a69f-f0a2-b9a6-6f55-688dcf702824.md)** to convert the value to a string.|
