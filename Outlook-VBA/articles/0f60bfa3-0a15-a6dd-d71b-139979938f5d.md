...
The  **AfterWrite** event occurs after the ** [Write](e0abe283-c3f4-fd1a-7a41-8b1dd0f6c161.md)** event. This event is not cancelable. To determine when the item is unloaded from memory, use the ** [Unload](2c6ac3e9-33d3-761a-be30-1963da1a73e7.md)** event.
