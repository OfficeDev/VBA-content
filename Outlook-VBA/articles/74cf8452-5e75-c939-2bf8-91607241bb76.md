 ...
 **In this article**
 [To specify the locale](#sectionSection0)
 [Optional: To specify a localization file](#sectionSection1)
 [Optional: To specify a localization string for the display name of the form region](#sectionSection2)
 [Optional: To specify a localization string for the form region identifier](#sectionSection3)
 [Optional: To specify a localization string for the description of the form region](#sectionSection4)
 [Optional: To specify a localization string for the display name of a control in the form region](#sectionSection5)
 [Optional: To specify a localization string for the display name of an action](#sectionSection6)
 [Optional: To specify a localization string for the subject prefix of an item resulting from an action](#sectionSection7)
