...
When the user tabs into an enabled  ** [MultiPage](ac0fa233-81fe-8a34-4113-6907c6d8f7e2.md)**, the first page in the control receives the focus. If the first page of a  **MultiPage** is disabled, the first enabled page of that control receives the focus. If all pages of a **MultiPage** are disabled, the control is disabled and cannot receive the focus.
