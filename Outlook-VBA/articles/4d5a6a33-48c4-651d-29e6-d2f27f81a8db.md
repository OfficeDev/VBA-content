...
Returns a  **Long** that represents the preferred horizontal position of the insertion point in a multiline ** [TextBox](4a0e4a3d-beca-9f94-7e27-469c4bafe250.md)**. Read-only.
