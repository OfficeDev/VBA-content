 ...
 **In this article**
 [To provide an identifier in the Windows registry](#sectionSection0)
 [Optional: To provide an internal identifier using the name element](#sectionSection1)
 [Optional: To provide a display name using the title element](#sectionSection2)
 [Optional: To provide a form region identifier using the formRegionName element](#sectionSection3)
...
For more information, see  [Specifying Form Regions in the Windows Registry](0de3fcb1-b357-8300-c943-9a5a788d4976.md).
