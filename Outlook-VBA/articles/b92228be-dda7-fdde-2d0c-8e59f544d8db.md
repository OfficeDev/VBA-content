...
For controls with captions, use the  ** [PicturePosition](516b3641-5def-8b3e-bad3-3cde9b0a738f.md)** property to specify where to display the picture on the object.
