...
Returns a  ** [RecurrencePattern](36c098f7-59fb-879a-5173-ed0260d13fa4.md)** object that represents the recurrence attributes of an appointment.
...
This Visual Basic for Applications (VBA) example uses  ** [CreateItem](e5fbf367-db16-5042-823e-68e6b805e612.md)**to create an  **AppointmentItem**object. The  **RecurrencePattern**is obtained for this item using the  **GetRecurrencePattern**method. By setting the  **RecurrencePattern** properties, ** [RecurrenceType](bc9b35b5-ef00-e5cf-09cc-ee8743efddcf.md)**,  ** [PatternStartDate](20c82dbd-a622-91b6-618c-7cbe8bff2ca7.md)**, and  ** [PatternEndDate](0f78ea71-3d92-2d38-be10-e05ab7bcf44a.md)**, the appointments are now a recurring series that occur on a daily basis for the period of one year.
