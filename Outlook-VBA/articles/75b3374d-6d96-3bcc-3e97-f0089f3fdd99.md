...
The following example uses the  **TripleState** property to allow Null as a legal value of a ** [CheckBox](1834855b-f96c-aaa1-24ce-81d1e4e4e1db.md)** and a ** [ToggleButton](01ce5640-9f19-3c0e-1aa4-96d87074bf8b.md)**. The user controls the value of  **TripleState** through ToggleButton2. The user can set the value of a **CheckBox** or **ToggleButton** based on the value of **TripleState**. However, when a control is set to  **Null**, no event is fired.
