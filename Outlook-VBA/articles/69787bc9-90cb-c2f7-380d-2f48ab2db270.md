...
Returns or sets a  **String** that identifies a group of mutually exclusive ** [ToggleButton](01ce5640-9f19-3c0e-1aa4-96d87074bf8b.md)** controls. Read/write.
...
To create a group of mutually exclusive  **ToggleButton** controls, you can put the buttons in a ** [Frame](5fb494d3-8e00-852a-c361-0e99358b1ce8.md)** on your form, or you can use the **GroupName** property. **GroupName** is more efficient for the following reasons:
...
For example, assume your form includes some toggle buttons and a  ** [MultiPage](ac0fa233-81fe-8a34-4113-6907c6d8f7e2.md)** that also includes toggle buttons. The toggle buttons on the **MultiPage** are one group and the buttons on the form are another group. The two groups do not affect each other. Changing the setting of a button on the **MultiPage** does not affect the buttons on the form.
