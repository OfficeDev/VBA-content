...
Returns the previous object in the  ** [Folders](0c814c3c-74fc-414c-982d-a0097fcb35c2.md)** collection.
...
A  ** [Folder](3cf6cda8-6d70-666e-2643-9d9c5b9cacfc.md)** object that represents the previous object contained by the collection.


## Remarks
<a name="sectionSection1"> </a>

It returns  **Nothing** if no previous object exists, for example, if already positioned at the beginning of the collection.To ensure correct operation of the ** [GetFirst](74757061-2f38-374e-1624-f8df211a711b.md)**,  ** [GetLast](6d981844-3ac0-c6f9-b2ee-9cf495ab6488.md)**,  ** [GetNext](5c2de8b2-b251-1983-a10b-1945abc38709.md)**, and  **GetPrevious** methods in a large collection, call **GetFirst** before calling **GetNext** on that collection, and call **GetLast** before calling **GetPrevious**. To ensure that you are always making the calls on the same collection, create an explicit variable that refers to that collection before entering the loop.
