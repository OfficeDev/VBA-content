...
Returns or sets a  **Variant** that identifies the source of data in a multicolumn ** [ListBox](f56ba480-f8fe-6d12-265e-3b0a9838af97.md)**. Read/write.
...
The possible values of  **BoundColumn** are 0 and 1. 0 assigns the value of the ** [ListIndex](2c4e473b-15e1-dce2-8748-30953b00a60f.md)** property to the control. 1 assigns the value from the specified column to the control. Columns are numbered from 1 when using this property (default).
...
The  ** [Column](9ad2c048-28f2-78d9-2f9d-b90c15f7967e.md)**,  ** [List](3eb66479-c7d2-13d7-ebd3-1a09eb136dbe.md)**, and  **ListIndex** properties all use zero-based numbering. That is, the value of the first item (column or row) is zero; the value of the second item is one, and so on. This means that if **BoundColumn** is set to 3, you could access the value stored in that column using the expression `Column(2)`.
