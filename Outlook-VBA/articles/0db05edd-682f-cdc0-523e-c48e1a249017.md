...
The following example demonstrates how to specify a mouse pointer that is appropriate for a specific control or situation. For the  ** [ListBox](f56ba480-f8fe-6d12-265e-3b0a9838af97.md)** control, you can assign one of several available mouse pointers using the ** [ListBox.MousePointer](4add5e4b-51d3-72a2-1459-47056201ec7a.md)** property.
