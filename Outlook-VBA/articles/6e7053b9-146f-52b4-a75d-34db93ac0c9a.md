...
Setting the  ** [PictureSizeMode](f6d435e4-c05c-cc0f-fae2-c5a95743a658.md)** property to 2 overrides **PictureAlignment**. When  **PictureSizeMode** is set to 2, the picture fills the entire control or container.
