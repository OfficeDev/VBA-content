...
To add a solution and its folders programmatically to the  **Solutions** module, you must use the ** [AddSolution](81d2edab-f8b3-340b-47b3-e98e780294ff.md)** method of the ** [SolutionsModule](4597765e-a95d-bf07-2ac4-103218ebc696.md)** object. You can customize the name of the module if there is only one solution in the module; otherwise the name reverts back to **Solutions**.
