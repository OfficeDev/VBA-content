...
Returns or sets a  **Boolean** value that indicates whether week number labels are displayed in the timeline scale for the ** [TimelineView](fb14c1a1-f542-fa1e-f30f-c5ee3d2f0206.md)** object. Read/write.
...
If this property is set to  **True**, the location in which week number labels are displayed in the timeline scale for the  **TimelineView** object depends on the value of the ** [TimelineViewMode](597facd9-74c4-266a-329d-c90bc77f8585.md)** property.
