...
If the  ** [KeepScrollBarsVisible](adc2bda2-6e7f-cd02-c6ca-f2976250fd60.md)** property is **True**, any scroll bar on a form or page is always visible, regardless of whether the object's contents fit within the object's borders.
