...
Returns or sets a  **Variant** that identifies the source of data in a multicolumn ** [ComboBox](31e7c1de-ee4e-b3d9-4579-7fc6b215bad3.md)**. Read/write.
...
The  ** [Column](f00c388f-fe1f-5458-281f-4bfa549291d5.md)**,  ** [List](687f44e8-7b4b-eab5-93b8-022cd4d1c302.md)**, and  **ListIndex** properties all use zero-based numbering. That is, the value of the first item (column or row) is zero; the value of the second item is one, and so on. This means that if **BoundColumn** is set to 3, you could access the value stored in that column using the expression `Column(2)`.
