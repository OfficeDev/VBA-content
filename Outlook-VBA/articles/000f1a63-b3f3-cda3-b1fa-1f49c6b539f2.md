...
The  **BeforeRead** event occurs before the ** [Read](f324f6b2-dda8-d481-a470-eb660614b6c1.md)** event. Unlike other events with the Before prefix, this event is not cancelable. To determine when the item is unloaded from memory, use the ** [Unload](9be47a73-0e85-6a60-462e-077ad9981667.md)** event.
