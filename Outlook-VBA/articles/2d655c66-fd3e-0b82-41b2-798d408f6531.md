...
Returns or sets a  **Boolean** value that indicates whether calendar items that do not occur within working hours should be included in the iCalendar (.ics) file created by the ** [ForwardAsICal](b796a573-784b-6725-535e-fd156a3f233c.md)** or ** [SaveAsICal](2314f751-77c5-9b95-05fb-c3075f512508.md)** methods of the ** [CalendarSharing](37a8a15e-51c2-b1a0-7db6-cf2a1f4e8405.md)** object. Read/write.
...
This property must be set to  **False** if the ** [CalendarDetail](f3f0ba8d-23db-505f-58c4-6e3a33a468e7.md)** property of the **CalendarSharing** object is set to **olFreeBusyOnly** or **olFullDetails**..
