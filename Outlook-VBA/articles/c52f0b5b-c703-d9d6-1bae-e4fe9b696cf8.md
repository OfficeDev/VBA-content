...
Setting the  ** [PictureSizeMode](24a0415a-f89a-c0fb-9c44-b33484c8cd49.md)** property to 2 overrides **PictureAlignment**. When  **PictureSizeMode** is set to 2, the picture fills the entire control or container.
