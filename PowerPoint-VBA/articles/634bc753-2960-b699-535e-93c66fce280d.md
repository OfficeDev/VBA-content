...
The value of this property accurately reflects the position of the callout line attachment to the text box only if the callout has an explicitly set drop value — that is, if the value of the  **[DropType](993a7cb5-afc6-0683-d8f1-5b71633f07bf.md)** property is **msoCalloutDropCustom**.
