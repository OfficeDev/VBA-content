...
|:-----|:-----|:-----|:-----|
| _Direction_|Required|**[XlErrorBarDirection](dde32437-fc46-0a20-f2b8-1f547ac15bff.md)**|One of the enumeration values that specifies the error bar direction.|
| _Include_|Required|**[XlErrorBarInclude](8ee44fac-0f0f-7211-1daf-ae2efb8ea587.md)**|One of the enumeration values that specifies the error bar parts to include.|
| _Type_|Required|**[XlErrorBarType](ea68417a-7478-5ad0-c2f9-721b484f912d.md)**|One of the enumeration values that specifies the error bar type.|
