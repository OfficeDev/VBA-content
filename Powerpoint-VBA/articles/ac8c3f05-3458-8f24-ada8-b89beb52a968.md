...
|:-----|:-----|:-----|:-----|
| _Appearance_|Optional|**[XlPictureAppearance](6f776149-460e-866b-65cb-05992cb56bdd.md)**|One of the enumeration values that specifies how the picture should be copied. The default is  **xlScreen**.|
| _Format_|Optional|**[XlCopyPictureFormat](a85812f6-0603-25a6-f511-985c9fa2c776.md)**|One of the enumeration values that specifies the format of the picture. The default is  **xlPicture**.|
