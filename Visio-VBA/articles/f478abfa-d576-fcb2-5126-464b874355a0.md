...
SRCStream() is an array of 2-byte integers. For **Shape** objects,SRCStream() should be a one-dimensional array of 3 _n_ 2-byte integers for some _n_ >= 1. **GetFormulasU** interprets the stream as:
