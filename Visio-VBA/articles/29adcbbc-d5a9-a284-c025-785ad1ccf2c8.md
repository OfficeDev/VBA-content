...
|:-----|:-----|:-----|:-----|
| _NestedOptions_|Required| **[VisContainerNested](7c6093cd-f575-19ad-a3dd-bdf345b869fd.md)**|Indicates whether to exclude shapes in the selection that are contained by containers or lists. See Remarks for possible values.|
