...
Private Sub  _expression__**UngroupCanceled**( **_ByVal Selection As [IVSELECTION]_**)
...
|:-----|:-----|:-----|:-----|
|Selection|Required| **[IVSELECTION]**|The selection of shapes that was going to be ungrouped.|
