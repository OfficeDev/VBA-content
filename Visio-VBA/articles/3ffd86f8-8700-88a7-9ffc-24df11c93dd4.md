...
Private Sub  _expression__**MouseMove**( **_ByVal Button As Long_**,  **_ByVal KeyButtonState As Long_**,  **_ByVal x As Double_**,  **_ByVal y As Double_**,  **_ByVal CancelDefault As Boolean_**)
...
|:-----|:-----|:-----|:-----|
|Button|Required| **Long**|The mouse button that was clicked. See Remarks for possible values.|
