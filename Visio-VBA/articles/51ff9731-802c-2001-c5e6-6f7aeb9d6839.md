...
|:-----|:-----|:-----|:-----|
|SID_SRCStream()|Required| **Integer**| A stream identifying cells to be queried.|
...
SID_SRCStream() is an array of 2-byte integers. For **Shape** objects,SID_SRCStream() should be a one-dimensional array of 3 _n_ 2-byte integers for some _n_ >= 1. **GetFormulas** interprets the stream as:
