...
If the object being operated on is a  **Window** object, and ifSelectAction is not **visSubSelect**, the parent shape of SheetObject must be the same shape as that returned by the **ContainingShape** property of the **Window.Selection** object.
...
Public Sub Select_Example() 
 ...
 'There are now four shapes on the pageâ€”a group that contains three 
