...
- Use an ampersand (&amp;) in the string to cause the next character in the string to become the shortcut key for that menu item. For example, the string "F _&amp;o_rmat" causes  _o_ to become the shortcut key for that menu item in that one menu.
