...
|:-----|:-----|:-----|:-----|
|CellObject|Required| **[IVCELL]**|An expression that returns a  **Cell** object that represents the part of the shape to glue to.|
...
-  **A cell of a guide or guide point:** When the begin or end cell of a 1-D shape is glued to a cell of a guide or guide point, two connections are createdâ€”one from the BeginX or EndX cell to the guide's Angle cell, and one from the BeginY or EndY cell to the guide's Angle cell.
...
-  **A cell of a guide or guide point:** When a control point is glued to a cell of a guide or guide point other than a connection point cell, two connections are createdâ€”one to the guide's PinX and one to the guide's PinY.
