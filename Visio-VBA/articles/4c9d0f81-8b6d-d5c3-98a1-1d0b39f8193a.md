...
Use the  _RunType_ argument to specify the type of run you want. You can use any of the constants declared by the Visio type library in **[VisRunTypes Constants](ec2d9be9-2e7a-50a1-b589-48c30a68b424.md)** . To find a list of _RunType_ values, see the **RunBegin** property.
