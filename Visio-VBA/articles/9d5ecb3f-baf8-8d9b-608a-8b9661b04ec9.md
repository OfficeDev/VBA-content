...
|visAnchorBarBuiltIn|6|Visio built-in window that has tabs at the bottom when mergedâ€”presently, the  **Custom Properties, Size &amp; Position, Drawing Explorer, Master Explorer, Pan &amp; Zoom and Validation Issues** windows (floating, anchored, or docked windows).|
