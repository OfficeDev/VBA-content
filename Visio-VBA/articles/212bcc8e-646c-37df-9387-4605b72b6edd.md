...
You can use various properties and methods of the  ** [ApplicationSettings](f2e24211-ecc6-e0f5-4c00-fc50f98a3505.md)** object that relate to raster images to configure settings for export to .bmp, .gif, .jpg, .png, and .tif file types.
