...
Private Sub  _expression__**KeyUp**( **_ByVal KeyCode As Long_**,  **_ByVal KeyButtonState As Long_**,  **_ByVal CancelDefault As Boolean_**)
...
|:-----|:-----|:-----|:-----|
|KeyCode|Required| **Long**|The key that was released. See Remarks for possible values.|
