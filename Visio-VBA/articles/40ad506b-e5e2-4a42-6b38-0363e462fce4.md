...
You can specify PinUnitsNameOrCode as an integer (a member of ** [VisUnitCodes](fce91c1b-d5c2-6522-2446-0b8f6cacbc84.md)**) or a string value such as "inches". If the string is invalid or the unit code is inappropriate (nontextual), an error is generated.
