...
|:-----|:-----|:-----|:-----|
| _Page_|Required| **[Page](7a7f37ab-b448-eb70-b4f1-c185dfbd511e.md)**|The subprocess page to which the selection should be moved. You cannot pass the current page.|
| _ObjectToDrop_|Required| **[UNKNOWN]**|The replacement shape to drop.|
| _NewShape_|Optional| **[Shape](da7a8872-4ebb-a607-e0ed-eebf68ff5630.md)**|Out parameter. Returns the shape that is linked to the new page.|
