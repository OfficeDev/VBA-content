...
|:-----|:-----|:-----|:-----|
|SID_SRCStream()|Required| **Integer**|An array identifying cells to be queried.|
...
SID_SRCStream() is an array of 2-byte integers. For **Style** objects,SID_SRCStream() should be a one-dimensional array of 3 _n_ 2-byte integers for _n_ >= 1. The **GetResults** method interpretsSID_SRCStream() as:
