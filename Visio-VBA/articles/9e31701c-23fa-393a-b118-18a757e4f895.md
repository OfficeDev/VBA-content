...
Private Sub  _expression__**BeforeModal**( **_ByVal app As [IVAPPLICATION]_**)
...
|:-----|:-----|:-----|:-----|
|app|Required| **[IVAPPLICATION]**|The instance of Visio that is going to enter a modal state.|
