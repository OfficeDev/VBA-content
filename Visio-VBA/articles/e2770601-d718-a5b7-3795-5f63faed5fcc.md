...
Private Sub  _expression__**DocumentSavedAs**( **_ByVal doc As [IVDOCUMENT]_**)
...
If you are handling this event from a program that receives a notification over a connection created by using the  **AddAdvise** method, thevarMoreInfo argument to **VisEventProc** designates the document index: "/doc=1".
