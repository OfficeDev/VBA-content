...
|:-----|:-----|:-----|:-----|
| _PublishDataRecordsets_|Required| **[VisPublishDataRecordsets](f0b9ad67-fabd-d0e2-74ca-61c2e6e242b9.md)**|Specifies whether all, no, or selected data recordsets are to be published. See Remarks for possible values.|
