...
|:-----|:-----|:-----|:-----|
|CriteriaString|Required| **String**|A string that conforms to the guidelines specified in the Microsoft ActiveX Data Object (ADO) API for setting the  **ADO.Filter** property|
