...
To get the row IDs of all the rows in the data recordset, use the  ** [GetDataRowIDs](d76874eb-c25b-df65-5d00-64de288d086e.md)** method. See the example in this topic.
