...
## Syntax
 ...
 _expression_An expression that returns a  **Event** object.
...
|:-----|:-----|:-----|:-----|
|filterActionStream()|Required| **Long**|An array of action/value pairs. For more information, see Remarks.|
...
The filterActionStream parameter is an array defined in the following way. The number of elements infilterActionStream is a multiple of 3:
