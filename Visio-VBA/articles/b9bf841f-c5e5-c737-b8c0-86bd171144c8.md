 ...
 **In this article**
 [Programming Visio Viewer in Visual Basic 6.0](#sectionSection0)
 [Programming Visio Viewer on an HTML (Web) page](#sectionSection1)
 [Programming Visio Viewer in managed code](#sectionSection2)
