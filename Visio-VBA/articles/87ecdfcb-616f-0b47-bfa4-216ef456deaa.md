...
Private Sub  _expression__**SelectionDeleteCanceled**( **_ByVal Selection As [IVSELECTION]_**)
...
|:-----|:-----|:-----|:-----|
|Selection|Required| **[IVSELECTION]**|The selection of shapes that was going to be deleted.|
