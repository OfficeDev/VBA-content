...
Private Sub  _expression__**MarkerEvent**( **_ByVal app As [IVAPPLICATION]_**,  **_ByVal SequenceNum As Long_**,  **_ByVal ContextString As String_**)
...
The  **EventInfo** property returnsContextString as described above. ThevarMoreInfo argument to **VisEventProc** will be empty.
