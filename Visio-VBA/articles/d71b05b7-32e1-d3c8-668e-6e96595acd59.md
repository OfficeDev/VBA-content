...
- The  _relation_ argument can be any combination of the constants defined in **[VisSpatialRelationCodes](4834dcb7-48e4-14c4-272f-3531892a0ccd.md)** . If _relation_ is not specified, the **SpatialSearch** property uses both relationships as criteria.
    
- The  _flags_ argument can be any combination of the values of the constants defined in **[VisSpatialRelationFlags](38e44579-2e2c-cdb9-524b-e2b864901c13.md)** in the Visio type library (except **visSpatialIncludeHidden** , which is reserved for future use, and should not be used).
