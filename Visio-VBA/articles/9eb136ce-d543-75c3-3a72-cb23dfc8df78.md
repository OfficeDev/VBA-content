...
|:-----|:-----|:-----|:-----|
| _ConnectionIDOrString_|Required| **Variant**|The ID of an existing  **[DataConnection](db21a645-d24d-253f-11ee-c75261d0896b.md)** object or the connection string to specify a new data-source connection.|
...
| _AddOptions_|Required| **Long**|Options that determine properties of the data recordset to add. A combination of one or more enumerated value from  **[VisDataRecordsetAddOptions](240726a5-48cb-3034-99cf-a42967a95daf.md)** . For more information, see Remarks.|
