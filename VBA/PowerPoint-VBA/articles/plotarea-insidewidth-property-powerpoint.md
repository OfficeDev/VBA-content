...
The plot area used for this measurement does not include the axis labels. The  **[Width](plotarea-width-property-powerpoint.md)** property for the plot area uses the bounding rectangle that includes the axis labels.
