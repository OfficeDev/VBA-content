...
Returns a  **[ProtectedViewWindows](protectedviewwindows-object-powerpoint.md)** collection that represents all the **Protected View** windows that are open in the application. Read-only
