...
|:------------------------------|:--------------------------------------------------------------------------------------|
| <strong>ppMouseClick</strong> | The action setting for when the user clicks the shape.                                |
| <strong>ppMouseOver</strong>  | The action setting for when the mouse pointer is positioned over the specified shape. |
