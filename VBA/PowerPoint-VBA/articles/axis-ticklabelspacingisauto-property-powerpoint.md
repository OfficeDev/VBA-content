...
The  **[TickLabelSpacing](axis-ticklabelspacing-property-powerpoint.md)** property returns the current tick label spacing, whether or not the setting is automatic.
