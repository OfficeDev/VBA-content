...
|:-----|:-----|:-----|:-----|
| _Style_|Required|**PjTeamPlannerStyle**|Can be one of the  **[PjTeamPlannerStyle](75cdc9ed-241e-c420-192b-2452fa66ae8c.md)** constants, which specify whether the task type is auto scheduled, manually scheduled, actual work, an external task, or a late task.|
