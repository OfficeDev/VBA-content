...
| _DateFormat_|Optional|**Long**|The date format. Can be one of the  **[PjDateFormat](d6bae7cd-4be0-b4eb-bbb1-5d82d7120bb2.md)** constants.|
...
| _SymbolPlacement_|Optional|**Long**|The position to display the currency symbol in currency values. Can be one of the following  **[PjPlacement](3f446d94-a76b-4862-e041-0e61775ea8ff.md)** constants: **pjAfter**, **pjAfterWithSpace**, **pjBefore**, or **pjBeforeWithSpace**.|
...
| _CalendarType_|Optional|**Integer**|Sets the type of calendar for displaying Project content on the screen. Can be one of the  **[pjCalendarType](c95af1e5-ec5d-230e-ea1c-572a70881985.md)** values.|
