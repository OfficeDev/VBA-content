...
Use  <strong>Availabilities(</strong><em>Index</em> <strong>)</strong>, where<em>Index</em> is the availability index number, to return a single <strong>Availability</strong> object. The following example returns the availability information from the first line of the <strong>Resource Availability</strong> grid for the specified resource.
