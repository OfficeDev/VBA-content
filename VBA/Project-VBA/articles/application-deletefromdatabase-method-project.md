...
In the following examples, <em> [My Documents]</em> is the full path of your My Documents folder, and <em>[Program Files]</em> is the full path of your Program Files folder:

"<Corporate SQL Database>\Factory Construction" 

"<  <em>[My Documents]\</em> PROJECT1.MDB>\System Roll-out Plan"
