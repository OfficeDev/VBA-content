...
|:-----|:-----|:-----|:-----|
| _Field_|Required|**Long**|The numerical constant for the custom field. Can be one of the  **[PjField](f0df0929-921c-1f33-ab42-192efdaeb64d.md)** constants for local custom fields or another **Long** value for enterprise custom fields.|
