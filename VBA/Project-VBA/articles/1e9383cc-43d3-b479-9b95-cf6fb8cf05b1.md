...
|:-----|:-----|:-----|:-----|
| _ResolveMethod_|Optional|**PjLevelSelectedOption**|Specifies what to resolve in the leveling process. Can be a  **[PjLevelSelectedOption](6d465e8c-b41e-de33-43e7-66fb92901651.md)** constant. The default is **pjResolveSelectedTasks**.|
