...
Use  <strong>CostRateTables(</strong><em>Index</em> <strong>)</strong>, where<em>Index</em> is the index number or name of the cost rate table, to return a single <strong>CostRateTable</strong> object.
