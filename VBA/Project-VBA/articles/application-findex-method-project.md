...
| _Test_|Optional|**String**|The type of comparison made between Field and Value. Can be one of the following comparison strings: 
...
| _SearchAllFields_|Optional|**Boolean**|If  **True**, search for the specified value in all available fields. The default is **False**.|
