...
| _openPool_|Optional|**Long**|The action to take when opening a resource pool or sharer file. When opening a master project, the value for  _openPool_ is also applied to the subprojects. Can be one of the[PjPoolOpen](d953d1cb-f8f9-740a-f20c-6ac1e2ee0366.md) constants. The default value is **pjPromptPool**.|
