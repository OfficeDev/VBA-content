...
| _DialogID_|Optional|**Long**|A constant specifying the dialog box to activate. Can be the following  **[PjDialog](c99b2a86-bd44-0a2c-1e26-db1241184845.md)** constant: **pjResourceAssignment**.|
