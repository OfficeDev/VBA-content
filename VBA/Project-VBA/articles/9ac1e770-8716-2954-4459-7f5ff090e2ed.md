...
|:-----|:-----|:-----|:-----|
| _FieldID_|Required|**Long**|For a local custom field, can be one of the  **[PjField](f0df0929-921c-1f33-ab42-192efdaeb64d.md)** constants for resource custom fields. For an enterprise custom field, use the **[FieldNameToFieldConstant](0830db06-22a7-3ca5-c9ca-f9efbc360767.md)** method to get the FieldID.|
