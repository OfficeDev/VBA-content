...
| _Type_|Optional|**Long**|The buttons to include in the message dialog box. Can be one of the  **[PjMessageType](683e2104-16d1-98db-1a2a-d1991b9276e7.md)** constants. The default value is **pjOKOnly**.|
