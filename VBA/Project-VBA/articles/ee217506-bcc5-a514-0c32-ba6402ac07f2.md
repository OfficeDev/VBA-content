...
The  **ExportAsFixedFormat** method is similar to the **[DocumentExport](891bf868-1256-2688-cdb2-2bccfbf2afc2.md)** method, except the _Filename_ parameter is required and the optional _FixedFormatExtClassPtr_ parameter is a pointer to a user-defined class that creates a custom PDF or XPS format.
