...
| _Order_|Optional|**Integer**|A constant that specifies how Project should resolve resource conflicts when leveling tasks in the active project. Can be one of the  **[PjLevelOrder](652f1d7c-6d15-4384-00f6-9791a2a65966.md)** constants. The default value is **pjLevelOrderStandard**.|
...
| _PeriodBasis_|Optional|**Integer**|Specifies how often Project should look for overallocated resources. Can be one of the  **[PjLevelPeriodBasis](4bfa73c9-f912-c35b-9582-ebc108dc625b.md)** constants. The default value is **pjDayByDay**.|
