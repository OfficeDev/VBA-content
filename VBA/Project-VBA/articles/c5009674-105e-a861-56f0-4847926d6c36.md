...
|:-----|:-----|:-----|:-----|
| _StartOnDate_|Optional|**PjNewTasksStartOnDate**|Specifies whether new tasks start on the project date, the current date, or no date. Can be one of the  **[PjNewTasksStartOnDate](d2f48f35-3783-168e-9d54-d7287203c1b0.md)** constants. The default is **pjProjectDate**.|
