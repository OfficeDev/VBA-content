...
For Excel, If LinkToContent is set to  <strong>True</strong>, you must supply an address or range name for the[LinkSource](http://msdn.microsoft.com/library/3e3a6ebc-615a-298e-c40f-cbb6d5cf63e3.md %28Office.15%29.aspx) from the workbook. If the address or range name covers more than one cell, the custom document property takes the value from the top left cell of the range.
