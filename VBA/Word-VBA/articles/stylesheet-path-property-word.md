...
The path doesn't include a trailing character—for example, "C:\MSOffice" or "<http://MyServer>". Use the  <strong><a href="application-pathseparator-property-word.md" data-raw-source="[PathSeparator](application-pathseparator-property-word.md)">PathSeparator</a></strong> property to add the character that separates folders and drive letters, and use the <strong><a href="stylesheet-name-property-word.md" data-raw-source="[Name](stylesheet-name-property-word.md)">Name</a></strong> property to return the file name without the path.
