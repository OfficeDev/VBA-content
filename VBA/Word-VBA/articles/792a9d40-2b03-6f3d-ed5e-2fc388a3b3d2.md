...
| _LanguageID_|Optional| **Variant**|The language used for the thesaurus. Can be one of the  **[WdLanguageID](9b3ef147-95f3-0eb6-db0c-0166fe7d2da2.md)** constants (although some of the constants may not be available to you, depending on the language support (U.S. English, for example) that you?ve selected or installed).|
