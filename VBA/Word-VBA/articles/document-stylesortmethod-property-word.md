...
Returns or sets a **[WdStyleSort](wdstylesort-enumeration-word.md)** constant that represents the sort method to use when sorting styles in the **Styles** task pane. Read/write.
