...
## Syntax
 ...
 _expression_ A variable that represents a **[Documents](fc4ac973-19c1-703a-5538-f4426b8b7564.md)** object.
...
| _Format_|Optional| **Variant**|The file converter to be used to open the document. Can be one of the  **[WdOpenFormat](48727357-ff8a-5516-9f45-09f0282ca89f.md)** constants. The default is **wdOpenFormatAuto** .|
...
| _DocumentDirection_|Optional| **Variant**|Indicates the horizontal flow of text in a document. Can be any valid  **[WdDocumentDirection](ce3aa3fd-93af-791e-99f1-08b39cd21fae.md)** constant. The default is **wdLeftToRight** .|
