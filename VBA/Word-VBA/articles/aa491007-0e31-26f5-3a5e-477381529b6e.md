...
| _EmbedTrueTypeFonts_|Optional| **Variant**| **True** to save TrueType fonts with the document. If omitted, the EmbedTrueTypeFonts argument assumes the value of the **[EmbedTrueTypeFonts](ac8fb6a1-584a-2ddb-4216-53e30473ff65.md)** property.|
...
| _LineEnding_|Optional| **Variant**|The way Word marks the line and paragraph breaks in documents saved as text files. Can be one of the following  **[WdLineEndingType](6a0d8e41-4248-e48f-1db6-77fa59a6f212.md)** constants: **wdCRLF** (default) or **wdCROnly** .|
...
| _CompatibilityMode_|Optional| **Variant**|The compatibility mode that Word uses when opening the document.  **[WdCompatibilityMode](244e1519-32ea-741c-7e2a-ff8a2e0713aa.md)** constant.
