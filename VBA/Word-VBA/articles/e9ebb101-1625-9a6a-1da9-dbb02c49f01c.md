...
| _ElementID_|Required| **Long**|When the method returns, this argument contains the  **[XlChartItem](66a4e750-6edf-18e9-ba02-72913796954b.md)** value of the chart element at the specified coordinates. For more information, see the Remarks section.|
