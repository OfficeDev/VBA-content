...
Constants that represent the extent of markup visible in the document, returned by and passed to the [RevisionsFilter.Markup](revisionsfilter-markup-property-word.md) property.
