...
You can also manipulate other Access objects through the  **Application** object. For example, by using the **[OpenForm](http://msdn.microsoft.com/library/a1c9d3a9-2af8-c30a-acb0-6428c70dcdb0%28Office.15%29.aspx)** method of the Access **[DoCmd](3ce44cca-9979-0a1e-9787-079a52ce528f.md)** object, you can open an Access form from Microsoft Office Excel:
