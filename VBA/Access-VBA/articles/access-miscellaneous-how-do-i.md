...
- [How to: Calculate Age](calculate-age.md)
    
      - Describes how to calculate the age of a person or thing based on a given date.
    
- [How to: Calculate and Display Specific Date Values](calculate-and-display-specific-date-values.md)
    
      - Describes how to create expressions for displaying specific dates and calculating time intervals.
    
- [How to: Calculate Elapsed Time](calculate-elapsed-time.md)
    
      - Describes how to calculate elapsed time.
    
- [How to: Find the Number of Working Days Between Two Dates](find-the-number-of-working-days-between-two-dates.md)
...
- [How to: Specify Date and Time in Criteria Expressions](specify-date-and-time-in-criteria-expressions.md)
...
- [How to: Include Quotation Marks in String Expressions](include-quotation-marks-in-string-expressions.md)
...
- [How to: Use Multiple Fields in Criteria Expressions](use-multiple-fields-in-criteria-expressions.md)
...
- [How to: Use Numeric Criteria in Expressions](use-numeric-criteria-in-expressions.md)
    
      - Describes how to specify numeric criteria for an operation.
    
- [How to: Use Textual Criteria Expressions](use-textual-criteria-expressions.md)
...
- [How to: Determine When a Shelled Process Ends](determine-when-a-shelled-process-ends.md)
...
- [How to: Retrieve Information from the Clipboard](retrieve-information-from-the-clipboard.md)
    
      - Describes two methods for pasting information form the Clipboard programmatically.
    
- [How to: Send Information to the Clipboard](send-information-to-the-clipboard.md)
    
      - Describes two methods for copying information to the Clipboard programmatically.
    
- [How to: Retrieve the Name of the User Logged On To the Network](retrieve-the-name-of-the-user-logged-on-to-the-network.md)
...
- [How to: Compact and Repair a Database](compact-and-repair-a-database.md)
    
      - Describes how to compact and repair a database.
    
- [How to: Recover Tables Deleted from a Database](recover-tables-deleted-from-a-database.md)
    
      - Describes a method for recovering tables that have been deleted.
    
- [How to: Handle Run-Time Errors in VBA](handle-run-time-errors-in-vba.md)
