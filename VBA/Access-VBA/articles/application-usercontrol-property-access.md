...
|:-------------------------|:----------------------------------------------------------------------------|
| <strong>True</strong>    | The current application was started by the user.                            |
| <strong>False</strong>   | The current application was started by another application with Automation. |
