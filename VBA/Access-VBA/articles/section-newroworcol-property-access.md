...
|:-------------------------|:------------------------------|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| None                     | 0                             | (Default) The row or column breaks are determined by the settings in the  <strong>Page Setup</strong> dialog box (available by clicking <strong>Page Setup</strong> on the <strong>File</strong> menu) and the available space on the page.             |
...
| <strong>Sample setting</strong> | <strong>Result</strong>                                                                                          |
|:--------------------------------|:-----------------------------------------------------------------------------------------------------------------|
