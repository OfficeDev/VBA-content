...
The  **CurrentData** object has several collections that contain specific **[AccessObject](accessobject-object-access.md)** objects within the current database. The following table lists the name of each collection defined by the database and the types of objects it contains.
...
|**Name**|
|:-----|
|[AllDatabaseDiagrams](currentdata-alldatabasediagrams-property-access.md)|
|[AllFunctions](currentdata-allfunctions-property-access.md)|
|[AllQueries](currentdata-allqueries-property-access.md)|
|[AllStoredProcedures](currentdata-allstoredprocedures-property-access.md)|
|[AllTables](currentdata-alltables-property-access.md)|
|[AllViews](currentdata-allviews-property-access.md)|
