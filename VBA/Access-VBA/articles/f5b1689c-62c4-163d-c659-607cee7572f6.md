...
| _ControlType_|Required|**AcControlType**|An  **[AcControlType](562ecad2-5cb5-7624-8f5a-236f42bd0104.md)** constant that represents the type of control you want to create.|
| _Section_|Optional|**AcSection**|An  **[AcSection](858401a2-e892-8729-124a-97a0fb136a0a.md)** constant that identifying the section that will contain the new control.|
