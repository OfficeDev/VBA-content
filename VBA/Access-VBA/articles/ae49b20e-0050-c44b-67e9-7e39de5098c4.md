...
The following four methods are used to move around, or scroll, in the  **Recordset**:[MoveFirst, MoveLast, MoveNext, and MovePrevious](d04ce41c-77c9-df42-115a-65c50a38518a.md). (Some of these methods are unavailable on forward-only cursors.)
