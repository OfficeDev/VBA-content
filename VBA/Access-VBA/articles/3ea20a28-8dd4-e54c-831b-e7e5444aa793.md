...
| _View_|Optional|**AcView**|A  **[AcView](708b0b90-8144-be34-f312-6914d4aa8e68.md)** constant that specifies the view in which the query will open. The default value is **acViewNormal**.|
| _DataMode_|Optional|**AcOpenDataMode**|A  **[AcOpenDataMode](e50b49fd-b77e-5ee5-d973-59ef46faddd7.md)** constant that specifies the data entry mode for the query. The default value is **acEdit**.|
