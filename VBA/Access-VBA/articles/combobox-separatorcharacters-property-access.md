...
Gets or sets the separator displayed between values when the combo box is bound to a multi-valued field. Read/write [AcSeparatorCharacters](acseparatorcharacters-enumeration-access.md).
