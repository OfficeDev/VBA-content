...
|:-------------------------|:------------------------------|:---------------------------------------------------------------------------------------------------|
| Yes                      | <strong>True</strong>         | The form will be centered automatically on opening.                                                |
| No                       | <strong>False</strong>        | (Default) The form upper-left corner will be in the same location as when the form was last saved. |
