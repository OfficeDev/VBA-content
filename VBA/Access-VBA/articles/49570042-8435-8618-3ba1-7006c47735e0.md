...
|**adFieldBadStatus**|12|Indicates that an invalid status value was sent from ADO to the OLE DB provider. Possible causes include an OLE DB 1.0 or 1.1 provider, or an improper combination of [Value](ff21d122-98e3-2b48-d92f-e696b8079fc5.md) and[Status](7a7b45e8-2934-2e8e-77fa-a4f38272548d.md).|
|**adFieldCannotComplete**|20|Indicates that the server of the URL specified by [Source](f36f0f5f-4493-d8c5-db4b-c72f5031bcb3.md) could not complete the operation.|
...
|**adFieldPendingChange**|0x40000|Indicates either that the field has been deleted and then re-added, perhaps with a different data type, or that the value of the field that previously had a status of adFieldOK has changed. The final form of the field will modify the [Fields](029aa738-8726-54a6-1813-b152813948bc.md) collection after the[Update](fc88cab6-c379-bb4f-530c-da08107924e0.md) method is called.|
