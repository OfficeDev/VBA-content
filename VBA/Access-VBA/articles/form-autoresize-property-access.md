...
|:-------------------------|:------------------------------|:----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Yes                      | <strong>True</strong>         | (Default) The Form window is automatically sized to display a complete record.                                                                                                                                                                                                                            |
| No                       | <strong>False</strong>        | When opened, the Form window has the last saved size. To save a window's size, open the form, size the window, save the form by clicking  <strong>Save</strong> on the <strong>File</strong> menu, and close the form or report. When you next open the form or report, it will be the saved window size. |
