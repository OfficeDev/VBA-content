...
Once you use the  **Edit** method, changes made to the current record's fields are copied to the copy buffer. After you make the desired changes to the record, use the **[Update](1b47606a-e79c-23f1-b120-46d1429bc167.md)** method to save your changes.
