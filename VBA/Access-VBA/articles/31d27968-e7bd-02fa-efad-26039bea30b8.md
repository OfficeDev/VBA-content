...
This is a schematic description of how to instantiate ADO events in Microsoft Visual C++. See [ADO Events Model Example (VC++)](3785406b-844c-419f-e6ac-78aa8c4e78b2.md) for a complete description.
...
Make it known that your event handlers are available by issuing  **QueryInterface** on the[Recordset](0f963bf8-f066-dc8a-b754-f427de712df1.md) and[Connection](c16023aa-0321-2513-ee71-255d6ffba03d.md) objects for the **IConnectionPointContainer** and **IConnectionPoint** interfaces. Then issue **IConnectionPoint::Advise** for each class.
