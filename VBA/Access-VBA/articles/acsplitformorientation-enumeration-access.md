...
Used with the [SplitFormOrientation](form-splitformorientation-property-access.md) property to specify the orientation of the datasheet in relation to the form while in Split Form view.
