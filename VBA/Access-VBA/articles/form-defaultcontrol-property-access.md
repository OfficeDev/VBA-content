...
The  **DefaultControl** property returns a **[Control](control-object-access.md)** object with which you can set the default properties for a particular type of control on a particular form. Read-only.
