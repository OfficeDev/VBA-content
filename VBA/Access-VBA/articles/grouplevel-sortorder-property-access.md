...
|:-------------------------|:------------------------------|:------------------------------------------------------------|
| Ascending                | <strong>False</strong>        | (Default) Sorts values in ascending (A to Z, 0 to 9) order. |
| Descending               | <strong>True</strong>         | Sorts values in descending (Z to A, 9 to 0) order.          |
