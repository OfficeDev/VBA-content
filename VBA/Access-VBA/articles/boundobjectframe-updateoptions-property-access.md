...
|:-------------------------|:--------------------------------------|:------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Automatic                | <strong>acOLEUpdateAutomatic</strong> | (Default) Updates the object each time the linked data changes.                                                                                                                                                               |
| Manual                   | <strong>acOLEUpdateManual</strong>    | Updates the object only when the control's  <strong>Action</strong> property is set to <strong>acOLEUpdate</strong> or the link is updated with the <strong>OLE/DDE Links</strong> command on the <strong>Edit</strong> menu. |
