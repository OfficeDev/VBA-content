...
You can create a [Recordset](0f963bf8-f066-dc8a-b754-f427de712df1.md) object and specify the column information. You can then insert data into the **Recordset** object; the underlying rowset buffers the inserts.

The following code example shows how to define a  **Recordset** by using the[RDSServer.DataFactory](1de76cdd-34dc-8547-29aa-48ad6067bdea.md) object. You can also do this with the[RDS.DataControl](ac430669-7628-696c-c036-b5d35405d788.md) object.
