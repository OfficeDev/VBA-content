...
|[CodePage](https://msdn.microsoft.com/en-us/library/windows/desktop/dd317756(v=vs.85).aspx)|Optional|**Variant**|A **Long** value indicating the character set of the code page. [Possible Values](https://msdn.microsoft.com/en-us/library/windows/desktop/dd317756(v=vs.85).aspx)|
