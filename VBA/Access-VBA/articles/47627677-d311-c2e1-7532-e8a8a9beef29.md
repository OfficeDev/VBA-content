...
|:-----|:-----|:-----|:-----|
| _ObjectType_|Required|**AcExportXMLObjectType**| A **[AcExportXMLObjectType](f84c49ca-bb99-705c-97ac-47f847fe060a.md)** that represents the type of **[AccessObject](8a770b33-5bff-120a-6707-ca214ee5ced3.md)** object to export.|
...
| _Encoding_|Optional|**AcExportXMLEncoding**|A  **[AcExportXMLEncoding](6d51f729-3f39-6521-d3ff-563bd6c66e50.md)** constant that specifies the text encoding to use for the exported XML. The default value is **acUTF8**.|
| _OtherFlags_|Optional|**AcExportXMLOtherFlags**|A bit mask that specifies other behaviors associated with exporting to XML. Can be a combination of  **[AcExportXMLOtherFlags](ebc80f42-56e8-e024-241a-a2ddc5d752ca.md)** constants.|
