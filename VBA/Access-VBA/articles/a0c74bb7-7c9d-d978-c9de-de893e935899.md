...
|DefaultSource|An  **Integer** that specifies the default bin from which the paper is fed. For available values, see the[DefaultSource member values](3c3c1c0d-5a96-4d59-d607-c8f0751725ae.md).|
...
|TTOption|An  **Integer** that specifies how TrueType fonts will be printed. For available values, see the[TTOption member values](c4f6e88c-e1b6-3350-85fd-b1be9ecc2189.md).|
