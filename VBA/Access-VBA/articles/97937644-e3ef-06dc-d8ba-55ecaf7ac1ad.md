...
This example demonstrates the [SortOrder](c2b8c84d-acc4-9929-fff5-9a088abbfcf1.md) property of a[Column](ad38c2df-f704-0599-4b7a-8556e430ba46.md) that has been appended to the[Columns](231645db-70da-9ad1-fb27-02145ce32e66.md) collection of an[Index](fe368ab1-e396-4684-d930-18b0ba58a925.md). The code appends an ascending index to the Country column in the  **Employees** table, then displays the records. Then the code appends a descending index to the Country column in the **Employees** table and displays the records again. The difference between ascending and descending indexes is shown.
