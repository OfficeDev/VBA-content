...
| _ObjectType_|Optional|**AcObjectType**|A  **[AcObjectType](157a8d35-2b27-4f62-8e74-525043f6ec71.md)** constant that specifies the type of object to rename. The default value is **acDefault**.|
