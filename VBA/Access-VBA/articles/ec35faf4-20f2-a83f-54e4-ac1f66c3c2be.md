...
Locates the previous record in a dynaset- or snapshot-type  **[Recordset](9774232c-e6da-175b-fc7f-ed2ab7908fa0.md)** object that satisfies the specified criteria and makes that record the current record (Microsoft Access workspaces only). .


## Syntax

 _expression_. **FindPrevious**( ** _Criteria_** )
