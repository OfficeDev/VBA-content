...
To display objects that are stored in a Microsoft Access database, use a [Bound object frame](9d087a78-278d-1b87-d1b4-22f836707efa.md).
...
You can use the unbound object frame or an [image control](1f938a6e-7aea-7787-d959-e21edaa9342c.md) to display unbound pictures in a form or report. The advantage of using the unbound object frame is that you can edit the object directly from the form or report. The advantage of using the image control is that it's faster to display.
