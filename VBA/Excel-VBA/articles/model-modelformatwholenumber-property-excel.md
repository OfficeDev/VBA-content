...
Returns a [ModelFormatWholeNumber](modelformatwholenumber-object-excel.md) object that represents formatting of type whole number in the data model. Read-only .
