...
| _ToAbsolute_|Optional| **Variant**|A constant of  **[XlReferenceType](a15bf421-985a-c72c-656b-d73689b45819.md)** which specifies the converted reference type. If this argument is omitted, the reference type isn't changed.|
