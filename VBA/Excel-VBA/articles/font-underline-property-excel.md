...
Returns or sets the type of underline applied to the font. Can be one of the **[XlUnderlineStyle](xlunderlinestyle-enumeration-excel.md)** constants. Read/write **Variant** .
