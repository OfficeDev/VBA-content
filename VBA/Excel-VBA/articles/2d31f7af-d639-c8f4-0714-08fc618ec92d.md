...
|[BinsCountValue](933ce137-4421-54c1-e3f7-f51466f6012d.md)|Specifies the number of bins in the histogram chart. Read/write  **Long**.|
|[BinsOverflowEnabled](3af8d552-94e1-6f15-df2b-38fb7d3a0be1.md)|Specifies whether a bin for values above the [BinsOverflowValue](411856a7-ac17-e9eb-35bd-c851c0cfdfdc.md) is enabled. Read/write **Boolean**.|
|[BinsOverflowValue](411856a7-ac17-e9eb-35bd-c851c0cfdfdc.md)|If an [BinsOverflowEnabled](3af8d552-94e1-6f15-df2b-38fb7d3a0be1.md) is **True**, specifies the value above which an overflow bin is displayed. Read/write  **Double**.|
|[BinsType](7230c44b-2e93-9790-2f27-d584688c6172.md)|Specifies how the horizontal axis of the histogram chart is formatted, by bins type. Read/write [XlBinsType](99482ffa-a40c-c2b4-a062-ce5ce2ad5b29.md).|
|[BinsUnderflowEnabled](719d315a-c3ed-77e9-3b42-0f6300b6bf8d.md)|Specifies whether a bin for values below the [BinsUnderflowValue](39a9ec75-8283-e603-fddd-e165a1641203.md) is enabled. Read/write **Boolean**.|
|[BinsUnderflowValue](39a9ec75-8283-e603-fddd-e165a1641203.md)|If an [BinsUnderflowEnabled](719d315a-c3ed-77e9-3b42-0f6300b6bf8d.md) is **True**, specifies the value below which an underflow bin is displayed. Read/write  **Double**.|
|[BinWidthValue](1b67cbda-6982-d16d-e039-6455cf7a845e.md)|Specifies the number of points in each range. Read/write  **Double**.|
