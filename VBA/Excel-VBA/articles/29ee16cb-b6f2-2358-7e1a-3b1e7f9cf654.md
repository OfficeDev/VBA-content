...
Returns a **Queries** collection that represents all the Get & Transform queries in the specified **Workbook**. Starting from Excel 2016, Get & Transform features enable you to connect, combine and shape data from a variety of sources to meet your analysis needs. Read-only **Queries** object.
