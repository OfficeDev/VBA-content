...
Because existing add-ins and macros can rely on Excel to seamlessly transmit the changes they make to the workbook to the coauthors, for the most part you can use your code in this new environment without making any changes or updates. However, in two particular cases, there may be problems that require you to adapt your code if you want it to work smoothly in a coauthoring setting:
...
**Figure 1. Sample of chart representing desserts sales**
