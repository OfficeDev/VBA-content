...
| _TableStyleName_|Optional| **Variant**|An  **[XlYesNoGuess](c4c8e9b1-ad12-5c63-da32-60d410915452.md)** constant that indicates whether the data being imported has column labels. If the Source does not contain headers, Excel will automatically generate headers.|
