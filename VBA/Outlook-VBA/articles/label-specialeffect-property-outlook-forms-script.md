...
|:-----------------------|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 0                      | Object appears flat, distinguished from the surrounding form by a border, a change of color, or both. Default for  <strong><a href="label-object-outlook-forms-script.md" data-raw-source="[Label](label-object-outlook-forms-script.md)">Label</a></strong>. |
