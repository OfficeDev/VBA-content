...
|:-----------------------|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 0                      | Object appears flat, distinguished from the surrounding form by a border, a change of color, or both. Default for  <strong><a href="image-object-outlook-forms-script.md" data-raw-source="[Image](image-object-outlook-forms-script.md)">Image</a></strong>. |
