...
|:-----|:-----|:-----|:-----|
| _Index_|Required| **Variant**|Either a 1-based  **long** value representing an index into the **Rules** collection, or a **string** name representing the value of the default property of a rule, **[Rule.Name](6c559ffe-b25c-ff49-31d1-1fd44935a8f3.md)** .|
