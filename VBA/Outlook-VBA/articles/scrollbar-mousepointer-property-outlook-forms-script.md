...
| 99                     | Uses the icon specified by the  <strong><a href="scrollbar-mouseicon-property-outlook-forms-script.md" data-raw-source="[MouseIcon](scrollbar-mouseicon-property-outlook-forms-script.md)">MouseIcon</a></strong> property. |
