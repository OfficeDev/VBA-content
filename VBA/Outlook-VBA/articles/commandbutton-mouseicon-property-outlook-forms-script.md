...
The  **MouseIcon** property is valid when the **[MousePointer](commandbutton-mousepointer-property-outlook-forms-script.md)** property is set to 99. The mouse icon of an object is the image that appears when the user moves the mouse across that object.
