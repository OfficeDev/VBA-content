...
|:--------------------------------|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| <strong>ControlTipText</strong> | Use this string as the control tip.                                                                                                                                 |
| <strong>Caption</strong>        | Use this string as the caption.                                                                                                                                     |
| <strong>Accelerator</strong>    | Use a single character as the value for the  <strong>ALT + Key</strong> entry. If you use a character from the caption of the control, the character is underlined. |
