...
| 99                     | Uses the icon specified by the  <strong><a href="checkbox-mouseicon-property-outlook-forms-script.md" data-raw-source="[MouseIcon](checkbox-mouseicon-property-outlook-forms-script.md)">MouseIcon</a></strong> property. |
