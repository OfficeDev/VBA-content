...
Returns a  **Single** value that represents the width dimension of the display area of a **[TabStrip](tabstrip-object-outlook-forms-script.md)**. Read-only.
