 ...
 **Note**  The namespace representation of the  **PidTagAttachDataBinary** property is http://schemas.microsoft.com/mapi/proptag/0x37010102. For more information about using the **PropertyAccessor** object on properties that are referenced by namespace, see [Referencing Properties by Namespace](c1c7bfa9-64d7-81d2-84e7-f0a4c57780b3.md).
...
#### Concepts
 ...
 [Attach a File to a Mail Item](1d94629b-e713-92cb-32de-c8910612e861.md)<br>
 [Attach an Outlook Contact Item to an Email Message](ae5240ad-dc3e-4499-8fd0-d8c2d90aa9ba.md)<br>
 [Limit the Size of an Attachment to an Outlook Email Message](9a240e17-f715-482c-9a8b-c6be1144e15a.md)<br>
