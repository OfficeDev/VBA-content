...
The  [COMAddIns](application-comaddins-property-outlook.md) property of the [Application](application-object-outlook.md) object gives you access to the COM add-ins loaded by Outlook.
