...
| _Index_|Required| **Variant**|Either a one-based index number at which to insert the new object, or a value used to match the  **[ViewXMLSchemaName](69490353-b470-6092-0b8e-b0f1c1549f7a.md)** property value of an object in the collection where the new object is to be inserted.|
