...
| 1                      | Pressing the  <strong>SPACEBAR</strong> or clicking selects or deselects an item in the list.                                                                                                                                                                                           |
| 2                      | Pressing  <strong>SHIFT</strong> and clicking the mouse, or pressing <strong>SHIFT</strong> and one of the arrow keys, extends the selection from the previously selected item to the current item. Pressing <strong>CTRL</strong> and clicking the mouse selects or deselects an item. |
