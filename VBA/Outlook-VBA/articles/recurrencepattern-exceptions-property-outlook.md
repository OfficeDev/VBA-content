...
Returns the  **[Exceptions](exceptions-object-outlook.md)** collection for a specified series of recurring appointments. Read-only.
...
This Visual Basic for Applications (VBA) example uses  **[CreateItem](application-createitem-method-outlook.md)** to create an **AppointmentItem** object. The **RecurrencePattern** is obtained for this item using the **[GetRecurrencePattern](appointmentitem-getrecurrencepattern-method-outlook.md)** method. By setting the **RecurrencePattern** properties, **[RecurrenceType](recurrencepattern-recurrencetype-property-outlook.md)** , **[PatternStartDate](recurrencepattern-patternstartdate-property-outlook.md)** , and **[PatternEndDate](recurrencepattern-patternenddate-property-outlook.md)** , the appointments are now a recurring series that occur on a daily basis for the period of one year.
