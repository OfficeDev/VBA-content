...
The value of the  **SaveOption** property is set when the **[BusinessCardView](businesscardview-object-outlook.md)** object is created by using the **[Add](views-add-method-outlook.md)** method of the **[Views](views-object-outlook.md)** collection.
