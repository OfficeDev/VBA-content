...
| 99                     | Uses the icon specified by the  <strong><a href="spinbutton-mouseicon-property-outlook-forms-script.md" data-raw-source="[MouseIcon](spinbutton-mouseicon-property-outlook-forms-script.md)">MouseIcon</a></strong> property. |
