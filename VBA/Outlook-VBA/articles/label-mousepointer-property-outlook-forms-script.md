...
| 99                     | Uses the icon specified by the  <strong><a href="label-mouseicon-property-outlook-forms-script.md" data-raw-source="[MouseIcon](label-mouseicon-property-outlook-forms-script.md)">MouseIcon</a></strong> property. |
