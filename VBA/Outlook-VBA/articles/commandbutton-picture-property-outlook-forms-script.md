...
For controls with captions, use the  **[PicturePosition](commandbutton-pictureposition-property-outlook-forms-script.md)** property to specify where to display the picture on the object.
