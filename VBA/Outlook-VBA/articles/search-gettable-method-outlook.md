...
The  <em>Filter</em> parameter supplied to <strong>Application.AdvancedSearch</strong> must be a DASL query. The filter for <strong>AdvancedSearch</strong> will not accept a JET query. Do not prefix a DASL query for <strong>AdvancedSearch</strong> with "@SQL=". If you add the "@SQL=" prefix, your query will raise an error. For more information on filters, see[Filtering Items](http://msdn.microsoft.com/library/4038e042-1b07-5d18-18b0-c2b58c9c42da%28Office.15%29.aspx).
