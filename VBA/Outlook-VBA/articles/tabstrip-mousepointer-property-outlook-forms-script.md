...
| 99                     | Uses the icon specified by the  <strong><a href="tabstrip-mouseicon-property-outlook-forms-script.md" data-raw-source="[MouseIcon](tabstrip-mouseicon-property-outlook-forms-script.md)">MouseIcon</a></strong> property. |
