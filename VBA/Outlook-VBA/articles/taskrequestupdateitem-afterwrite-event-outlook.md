...
The  **AfterWrite** event occurs after the **[Write](taskrequestupdateitem-write-event-outlook.md)** event. This event is not cancelable. To determine when the item is unloaded from memory, use the **[Unload](taskrequestupdateitem-unload-event-outlook.md)** event.
