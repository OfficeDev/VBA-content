...
|:-----|:-----|:-----|:-----|
| _Context_|Required| **Variant**|Either a  **String** value or a **[Folder](3cf6cda8-6d70-666e-2643-9d9c5b9cacfc.md)** object representing the sharing context to be used.|
| _Provider_|Optional| **Variant**|An  **[OlSharingProvider](b42c20dc-e90d-264b-38d7-686cd74a547f.md)** value representing the sharing provider to be used.|
