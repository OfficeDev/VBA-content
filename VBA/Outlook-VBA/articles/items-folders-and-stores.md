...
-  [Import Appointment XML Data into Outlook Appointment Objects (Outlook)](import-appointment-xml-data-into-outlook-appointment-objects-outlook.md)
    
-  [Obtain a Folder Object from a Folder Path](obtain-a-folder-object-from-a-folder-path.md)
    
-  [Send an E-mail Given the SMTP Address of an Account (Outlook)](send-an-e-mail-given-the-smtp-address-of-an-account-outlook.md)
