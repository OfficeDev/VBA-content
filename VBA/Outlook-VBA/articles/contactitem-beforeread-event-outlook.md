...
The  **BeforeRead** event occurs before the **[Read](contactitem-read-event-outlook.md)** event. Unlike other events with the Before prefix, this event is not cancelable. To determine when the item is unloaded from memory, use the **[Unload](contactitem-unload-event-outlook.md)** event.
...
-  **[Class](contactitem-class-property-outlook.md)**
    
-  **[MessageClass](contactitem-messageclass-property-outlook.md)**
