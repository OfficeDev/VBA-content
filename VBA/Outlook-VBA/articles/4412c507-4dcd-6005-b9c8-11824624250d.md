...
|[DisplayModeChange](cee77aad-8905-efed-466e-c2e88cfeeaa2.md)|Occurs when the user performs an action that changes the display mode. Possible modes include Normal, Portrait View, and Portrait Reading Pane.|
...
|[Search](d4dc7ae5-c24f-90df-f52e-e0b73293e25d.md)|Performs a Microsoft Instant Search on the current folder displayed in the Explorer using the given  _Query_.|
