...
| _fillMatrix_|Required|[VISQUICKSTYLEMATRIXINDICES](0fb0b448-85ba-4fc4-d933-21d574cefa2a.md)|Specifies the shape style index that determines the fill-formatting properties (for example, fill type or gradient stops) to retrieve from the active theme and variant.|
