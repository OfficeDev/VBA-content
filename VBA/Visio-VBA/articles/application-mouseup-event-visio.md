...
Private Sub  <em>expression</em> <em><strong>MouseUp</strong>( **_ByVal Button As Long</em>** , <strong><em>ByVal KeyButtonState As Long</em></strong> , <strong><em>ByVal x As Double</em></strong> , <strong><em>ByVal y As Double</em></strong> , <strong><em>ByVal CancelDefault As Boolean</em></strong> )
