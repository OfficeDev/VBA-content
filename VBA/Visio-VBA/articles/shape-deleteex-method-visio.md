...
|:-----------------------------------------------|:-----------------------|:-------------------------------------------------------------------|
| <strong>visDeleteNormal</strong>               | 0                      | Match the deletion behavior that is in the user interface.         |
| <strong>visDeleteHealConnectors</strong>       | 1                      | Delete connectors that are attached to deleted shapes.             |
| <strong>visDeleteNoHealConnectors</strong>     | 2                      | Do not delete connectors that are attached to deleted shapes.      |
| <strong>visDeleteNoContainerMembers</strong>   | 4                      | Do not delete unselected members of containers or lists.           |
| <strong>visDeleteNoAssociatedCallouts</strong> | 8                      | Do not delete unselected callouts that are associated with shapes. |
