...
## Remarks
 ...
 _ObjectToDrop_ is typically a Microsoft Visio object, such as a **[Master](master-object-visio.md)** or **[MasterShortcut](mastershortcut-object-visio.md)** object. However, it can be any OLE object that provides an **IDataObject** interface. If _ObjectToDrop_ is null, Visio drops a default shape.
