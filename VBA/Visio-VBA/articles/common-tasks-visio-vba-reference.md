...
-  [Add Macros or Add-ons to Shape's Shortcut Menus](add-macros-or-add-ons-to-a-shape-s-shortcut-menu.md)
...
-  [Change the Macro Security Settings for Visio](change-the-macro-settings-for-visio.md)
