...
| <strong>visSpatialIncludeHidden</strong>       | &;H10      | Consider hidden Geometry sections. By default, hidden Geometry sections do not influence the result.                                                                                                                                                                                                  |
| <strong>visSpatialIgnoreVisible</strong>       | &;H20      | Do not consider visible Geometry sections. By default, visible Geometry sections influence the result.                                                                                                                                                                                                |
