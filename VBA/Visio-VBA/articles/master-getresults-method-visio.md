...
|:-------------------------------------|:-----------------------|:-----------------------------------------------------|
| <strong>visGetFloats</strong>        | 0                      | Results returned as doubles (VT_R8).                 |
| <strong>visGetTruncatedInts</strong> | 1                      | Results returned as truncated long integers (VT_I4). |
| <strong>visGetRoundedInts</strong>   | 2                      | Results returned as rounded long integers (VT_I4).   |
| <strong>visGetStrings</strong>       | 3                      | Results returned as strings (VT_BSTR).               |
| <strong>visGetFormulas</strong>      | 4                      | Formulas returned as strings (VT_BSTR).              |
| <strong>visGetFormulasU</strong>     | 5                      | Formulas returned in universal syntax (VT_BSTR).     |
