...
| <strong>visBBoxIncludeDataGraphics</strong> | &;H10000               | Includes data-graphic callout shapes (and their sub-shapes) that are applied to the shapes on the page. Off by default.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
