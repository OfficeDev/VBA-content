...
| <strong>visBBoxIncludeDataGraphics</strong> | &;H10000               | Includes data-graphic callout shapes (and their sub-shapes) that are applied to the shapes of the master. Off by default.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
