...
|:----------------------------------------------|:-----------------------|:----------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| <strong>visRefreshNoReconciliationUI</strong> | 2                      | Disables the  <strong>Refresh Conflicts</strong> task pane in the Visio user interface (UI) after a refresh operation.                                                |
| <strong>visRefreshOverwriteAll</strong>       | 1                      | When data is refreshed, overwrites all user changes made in the shape data of shapes linked to data in this recordset since the previous refresh operation. See note. |
