...
Private Sub  <em>expression</em> <em><strong>ShapeLinkAdded</strong>( **_ByVal Shape As [IVSHAPE]</em>** , <strong><em>ByVal DataRecordsetID As Long</em></strong> , <strong><em>ByVal DataRowID As Long</em></strong> )
