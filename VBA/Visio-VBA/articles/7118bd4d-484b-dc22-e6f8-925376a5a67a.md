...
| _AddOptions_|Required| **Long**|Options that determine properties of the data recordset to be added. A combination of one or more enumerated value from  **[VisDataRecordsetAddOptions](240726a5-48cb-3034-99cf-a42967a95daf.md)** . For more information, see Remarks.|
