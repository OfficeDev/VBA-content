...
|:-----|:-----|:-----|:-----|
| _Flags_|Required| **[VisLangFlags](9654b6db-072a-6bcb-929d-05d18cb96009.md)**|Out parameter. Indicates whether universal or local page names are returned in  _NamesArray_. See Remarks for possible values.|
| _PublishPages_|Required| **[VisPublishPages](a638bea0-67e5-0fd1-1984-ffafb37afcb2.md)**|Out parameter. Indicates whether all pages or selected pages are set to be published. See Remarks for possible values.|
