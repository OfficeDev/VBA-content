...
| <em>Boolean</em>      | Optional. Whether the text entered must match an existing item in the list. |
...
|:-----------------------|:----------------------------------------------------------------------------|
| <strong>True</strong>  | The text entered must match an existing list entry.                         |
| <strong>False</strong> | The text entered can be different from all existing list entries (default). |
