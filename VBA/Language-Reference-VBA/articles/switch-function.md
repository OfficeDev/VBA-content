...
|:----------------------|:--------------------------------------------------------------------------------------------------------|
| <em>expr</em>         | Required. [Variant expression](vbe-glossary.md) you want to evaluate.                                   |
| <em>value</em>        | Required. Value or expression to be returned if the corresponding expression is  <strong>True</strong>. |
