...
| <em>Boolean</em>      | Optional. Whether the control has more than one row of tabs. |
...
|:-----------------------|:------------------------------------------|
| <strong>True</strong>  | Allows more than one row of tabs.         |
| <strong>False</strong> | Restricts tabs to a single row (default). |
