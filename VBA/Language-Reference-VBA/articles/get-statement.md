...
| <em>recnumber</em>    | Optional.  <strong>Variant</strong> ( <strong>Long</strong> ). Record number ( <strong>Random</strong> mode files) or byte number ( <strong>Binary</strong> mode files) at which reading begins. |
| <em>varname</em>      | Required. Valid variable name into which data is read.                                                                                                                                           |
