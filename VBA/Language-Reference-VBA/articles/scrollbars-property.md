...
| <em>fmScrollBars</em> | Optional. Where scroll bars should be displayed. |
...
|:--------------------------------|:-----------------------|:------------------------------------------------------|
| <em>fmScrollBarsNone</em>       | 0                      | Displays no scroll bars (default).                    |
...
| <em>fmScrollBarsBoth</em>       | 3                      | Displays both a horizontal and a vertical scroll bar. |
