...
|:---------------------------------|:----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| <strong><em>string</em></strong> | Required. [String expression](vbe-glossary.md) specifying the keystrokes to send.                                                                                                                                                                                                                         |
| <strong><em>Wait</em></strong>   | Optional. [Boolean](vbe-glossary.md) value specifying the wait mode. If <strong>False</strong> (default), control is returned to the[procedure](vbe-glossary.md) immediately after the keys are sent. If <strong>True</strong>, keystrokes must be processed before control is returned to the procedure. |
...
| <strong>Key</strong> | <strong>Code</strong>         |
|:---------------------|:------------------------------|
