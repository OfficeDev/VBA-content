...
| <em>eventname</em>    | Required. A [string expression](vbe-glossary.md) specifying the name of the event you want to add to the[module](vbe-glossary.md). |
| <em>objectname</em>   | Required. A string expression specifying the name of the object that is the source of the event.                                   |
