...
- Project — Displays the name of the current [project](b8bdf64f-5920-1ae9-16d0-b26d09524a30.md). Expressions can't be evaluated in a context outside of the current project.
