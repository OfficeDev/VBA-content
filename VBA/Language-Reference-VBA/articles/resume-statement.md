...
|**Resume** _line_|Execution resumes at the  _line_ specified in the required _line_ [argument](vbe-glossary.md). The  _line_ argument is a [line label](vbe-glossary.md) or [line number](vbe-glossary.md) and must be in the same procedure as the error handler.|
