...
|:----------------------------------------------|:---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| <strong>Resume</strong>                       | If the error occurred in the same [procedure](vbe-glossary.md) as the error handler, execution resumes with the statement that caused the error. If the error occurred in a called procedure, execution resumes at the[statement](vbe-glossary.md) that last called out of the procedure containing the error-handling routine.                                                                                            |
| <strong>Resume</strong> <strong>Next</strong> | If the error occurred in the same procedure as the error handler, execution resumes with the statement immediately following the statement that caused the error. If the error occurred in a called procedure, execution resumes with the statement immediately following the statement that last called out of the procedure containing the error-handling routine (or  <strong>On Error Resume Next</strong> statement). |
| <strong>Resume</strong><em>line</em>          | Execution resumes at  <em>line</em> specified in the required <em>line</em>[argument](vbe-glossary.md). The  <em>line</em> argument is a[line label](vbe-glossary.md) or[line number](vbe-glossary.md) and must be in the same procedure as the error handler.                                                                                                                                                             |
