...
| <em>recnumber</em>    | Optional.  <strong>Variant</strong> ( <strong>Long</strong> ). Record number ( <strong>Random</strong> mode files) or byte number ( <strong>Binary</strong> mode files) at which writing begins. |
| <em>varname</em>      | Required. Name of variable containing data to be written to disk.                                                                                                                                |
