...
|:--------------------------------|:-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| <strong><em>nper</em></strong>  | Required.  <strong>Double</strong> specifying total number of payment periods in the annuity. For example, if you make monthly payments on a four-year car loan, your loan has a total of 4 * 12 (or 48) payment periods.                                                                                                                                          |
| <strong><em>pmt</em></strong>   | Required.  <strong>Double</strong> specifying payment to be made each period. Payments usually contain principal and interest that doesn't change over the life of the annuity.                                                                                                                                                                                    |
| <strong><em>pv</em></strong>    | Required.  <strong>Double</strong> specifying present value, or value today, of a series of future payments or receipts. For example, when you borrow money to buy a car, the loan amount is the present value to the lender of the monthly car payments you will make.                                                                                            |
| <strong><em>fv</em></strong>    | Optional. [Variant](vbe-glossary.md) specifying future value or cash balance you want after you make the final payment. For example, the future value of a loan is $0 because that's its value after the final payment. However, if you want to save $50,000 over 18 years for your child's education, then $50,000 is the future value. If omitted, 0 is assumed. |
| <strong><em>type</em></strong>  | Optional.  <strong>Variant</strong> specifying a number indicating when payments are due. Use 0 if payments are due at the end of the payment period, or use 1 if payments are due at the beginning of the period. If omitted, 0 is assumed.                                                                                                                       |
| <strong><em>guess</em></strong> | Optional.  <strong>Variant</strong> specifying value you estimate will be returned by <strong>Rate</strong>. If omitted, <strong><em>guess</em></strong> is 0.1 (10 percent).                                                                                                                                                                                      |
