...
| <em>Boolean</em>      | Optional. Specifies whether a control takes the focus when clicked. |
...
|:-----------------------|:---------------------------------------------------|
| <strong>True</strong>  | The button takes the focus when clicked (default). |
| <strong>False</strong> | The button does not take the focus when clicked.   |
