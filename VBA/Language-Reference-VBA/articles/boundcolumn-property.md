...
| <em>Variant</em>      | Optional. Indicates how the  <strong>BoundColumn</strong> value is selected. |
...
|:-----------------------|:----------------------------------------------------------------------------------------------------------------------------|
| 0                      | Assigns the value of the  <strong>ListIndex</strong> property to the control.                                               |
