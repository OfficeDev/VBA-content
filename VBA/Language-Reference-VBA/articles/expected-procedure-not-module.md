...
There is no [procedure](vbe-glossary.md) by this name in the current[scope](vbe-glossary.md), but there is a [module](vbe-glossary.md) by this name. You can call a procedure, but not a module. This error has the following cause and solution:
