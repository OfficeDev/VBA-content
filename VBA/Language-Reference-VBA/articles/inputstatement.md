...
| <em>varlist</em>      | Required. Comma-delimited list of variables that are assigned values read from the file — can't be an [array](vbe-glossary.md) or[object variable](vbe-glossary.md). However, variables that describe an element of an array or [user-defined type](vbe-glossary.md) may be used. |
...
| <strong>Data</strong>            | <strong>Value assigned to variable</strong>                                       |
|:---------------------------------|:----------------------------------------------------------------------------------|
| Delimiting comma or blank line   | [Empty](vbe-glossary.md)                                                          |
| #NULL#                           | [Null](vbe-glossary.md)                                                           |
| #TRUE# or #FALSE#                | <strong>True</strong> or <strong>False</strong>                                   |
| # <em>yyyy-mm-dd hh:mm:ss</em> # | The date and/or time represented by the [expression](vbe-glossary.md)             |
| #ERROR  <em>errornumber</em> #   | <em>errornumber</em> (variable is a[Variant](vbe-glossary.md) tagged as an error) |
