...
|:---------------------------------|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| <strong><em>string</em></strong> | Required. [String expression](vbe-glossary.md) from which the leftmost characters are returned. If <strong><em>string</em></strong> contains[Null](vbe-glossary.md), Null is returned.                                                                                                                              |
