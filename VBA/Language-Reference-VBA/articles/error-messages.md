...
- [Run-time error <number>:](run-time-error-number.md)
...
- [User-defined type may not be passed ByVal](user-defined-type-may-not-be-passed-byval.md)
    
- [User-defined type not defined](user-defined-type-not-defined.md)
    
- [User-defined type without members not allowed](user-defined-type-without-members-not-allowed.md)
