...
|:----------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| <em>object</em>       | Required. A valid  <strong>OptionButton</strong>.                                                                                                                            |
| <em>String</em>       | Optional. The name of the group that includes the  <strong>OptionButton</strong>. Use the same setting for all buttons in the group. The default setting is an empty string. |
