...
| <em>Variant</em>      | Optional. The width of the list. A value of zero makes the list as wide as the  <strong>ComboBox</strong>. The default value is to make the list as wide as the text portion of the control. |
