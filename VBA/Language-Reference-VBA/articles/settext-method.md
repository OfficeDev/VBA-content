...
| <em>StoreData</em>    | Required. Defines the data to store on the  <strong>DataObject</strong>.                                                                                                                     |
| <em>format</em>       | Optional. An integer or string specifying the format of  <em>StoreData</em>. When retrieving data from the <strong>DataObject</strong>, the format identifies the piece of data to retrieve. |
...
|:---------------------------------------|:----------------------------------------------------|
| 1                                      | Text format.                                        |
| A string or integer value other than 1 | A user-defined  <strong>DataObject</strong> format. |
