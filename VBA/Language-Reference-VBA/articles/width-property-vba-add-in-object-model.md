...
Returns or sets a [Single](vbe-glossary.md) containing the width of the window in[twips](vbe-glossary.md). Read/write.
 **Remarks**
Changing the  **Width** property setting of a[linked window](vbe-glossary.md) or[docked window](vbe-glossary.md) has no effect as long as the window remains linked or docked.
