...
Code within a [module](vbe-glossary.md) is organized into[procedures](vbe-glossary.md). A procedure tells the application how to perform a specific task. Use procedures to divide complex code tasks into more manageable units.
...
6. You can select the  **All Local Variables as Statics** to add the **Static**[keyword](vbe-glossary.md) to the procedure definition.
