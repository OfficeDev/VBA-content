...
<strong>Private Sub</strong><em>object</em> <em><strong>Click(</strong>_index</em><strong>As Long)</strong>
For all other controls 
<strong>Private Sub</strong><em>object</em> _<strong>Click( )</strong>
The  
<strong>Click</strong> event syntax has these parts:
