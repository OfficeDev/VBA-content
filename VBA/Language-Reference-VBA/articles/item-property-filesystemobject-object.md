...
|:----------------------|:----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| <em>object</em>       | Required. Always the name of a collection or  <strong>Dictionary</strong> object.                                                                                                       |
| <em>key</em>          | Required.  <em>Key</em> associated with the item being retrieved or added.                                                                                                              |
| <em>newitem</em>      | Optional. Used for  <strong>Dictionary</strong> object only; no application for collections. If provided, <em>newitem</em> is the new value associated with the specified <em>key</em>. |
