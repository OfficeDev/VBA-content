...
|:---------------------------------|:----------------------------------------------------------------------------------------------------------------------------------------------------|
| <strong><em>number</em></strong> | Required. Whole number that you want to evaluate against the ranges.                                                                                |
| <strong><em>start</em></strong>  | Required. Whole number that is the start of the overall range of numbers. The number can't be less than 0.                                          |
| <strong><em>stop</em></strong>   | Required. Whole number that is the end of the overall range of numbers. The number can't be equal to or less than  <strong><em>start</em></strong>. |
...
| <strong><em>start</em></strong> | <strong><em>stop</em></strong> | <strong><em>interval</em></strong> | <strong>Before First</strong> | <strong>First Range</strong> | <strong>Last Range</strong> | <strong>After Last</strong> |
|:--------------------------------|:-------------------------------|:-----------------------------------|:------------------------------|:-----------------------------|:----------------------------|:----------------------------|
