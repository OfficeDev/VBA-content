...
| <em>Long</em>         | Optional. A positive integer specifies the [context ID](glossary-vba.md) of a topic in the Help file associated with the object. Zero indicates no Help topic is associated with the object (default). Must be a valid context ID in the specified Help file. |
