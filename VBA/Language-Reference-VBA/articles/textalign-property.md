...
| <em>fmTextAlign</em>  | Optional. How text is aligned in the control. |
...
|:---------------------------|:-----------------------|:-----------------------------------------------------------------------------------------------------------------|
| <em>fmTextAlignLeft</em>   | 1                      | Aligns the first character of displayed text with the left edge of the control's display or edit area (default). |
| <em>fmTextAlignCenter</em> | 2                      | Centers the text in the control's display or edit area.                                                          |
| <em>fmTextAlignRight</em>  | 3                      | Aligns the last character of displayed text with the right edge of the control's display or edit area.           |
