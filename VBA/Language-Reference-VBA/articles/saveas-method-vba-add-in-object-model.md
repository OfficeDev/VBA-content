...
|:----------------------|:------------------------------------------------------------------------------------------------------------|
| <em>object</em>       | An [object expression](vbe-glossary.md) that evaluates to an object in the Applies To list.                 |
| <em>newfilename</em>  | Required. A [string expression](vbe-glossary.md) specifying the new filename for the component to be saved. |
