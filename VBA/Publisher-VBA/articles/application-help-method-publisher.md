...
|:------------------------------------|:------------------------------------------------------------------------------|
| <strong>pbHelp</strong>             | Displays the  <strong>Help Topics</strong> dialog box.                        |
| <strong>pbHelpActiveWindow</strong> | Displays Help describing the command associated with the active view or pane. |
| <strong>pbHelpPSSHelp</strong>      | Displays product support information.                                         |
