---
title: "Объект ParagraphFormat (издатель)"
...
ms.date: 06/08/2017
ms.openlocfilehash: 2f32f908cf15e4aeda555c81b9b8a78ec01757bd
ms.sourcegitcommit: 1102fd44df64f18dc0561d0b3a7103ca81e74318
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 07/26/2017
---
# <a name="paragraphformat-object-publisher"></a>Объект ParagraphFormat (издатель)

Представляет форматирования для абзаца.


## <a name="example"></a>Пример

Свойство **[ParagraphFormat](http://msdn.microsoft.com/library/5ab0a2ec-d7a9-f3af-29e7-5421427ee783%28Office.15%29.aspx)** используется для возврата объекта **ParagraphFormat** для абзацев. Свойство **ParagraphFormat** возвращает объект **ParagraphFormat** для выбора, диапазон или стиля. Следующий пример центры абзац с позиции курсора. В этом примере предполагает, что первую фигуру текстовое поле и не другого типа фигуры.
...
Используйте свойство **[дублирующиеся](http://msdn.microsoft.com/library/545dbfdb-4cd5-99b1-1ba3-b723e8d7b827%28Office.15%29.aspx)** для копирования существующего объекта **ParagraphFormat** . В следующем примере дублирует форматирование абзаца в первый абзац active публикации и сохранение форматирования в переменной. В этом примере дублирует существующий объект **ParagraphFormat** и затем изменение отступа на один дюйм, создает новый элемент textbox, со вставленным текстом в нее и применяется форматирование абзаца формат дублируемые абзаца для текста.
...
|**Name**|
|:-----|
|[Дублирующиеся](http://msdn.microsoft.com/library/83156999-7867-05c2-9e85-4cc0f580ac6e%28Office.15%29.aspx)|
|[Сброс](http://msdn.microsoft.com/library/8ef5c799-cace-133c-33d3-3454df2c2f24%28Office.15%29.aspx)|
...
|**Name**|
|:-----|
|[Выравнивание](http://msdn.microsoft.com/library/db66f8b8-a813-418c-2735-e5299e6a6045%28Office.15%29.aspx)|
|[Приложения](http://msdn.microsoft.com/library/c8c5c15f-6cb2-86cc-a546-2616e23a1cca%28Office.15%29.aspx)|
...
|[Родительский раздел](http://msdn.microsoft.com/library/afa92f13-222f-d48c-c739-9b21f15f1868%28Office.15%29.aspx)|
...
|[Вкладки](http://msdn.microsoft.com/library/c42ba898-b84f-7215-129d-8134670f75ac%28Office.15%29.aspx)|
|[TextDirection](http://msdn.microsoft.com/library/b96c634d-0e7e-dba8-2bf4-e5baf3afa3d1%28Office.15%29.aspx)|
|[Стиля текста](http://msdn.microsoft.com/library/8495c9c8-387e-a2e8-26cb-08f660dde985%28Office.15%29.aspx)|
