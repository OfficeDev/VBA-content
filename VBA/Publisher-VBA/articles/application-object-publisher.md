---
title: "Объект Application (издатель)"
...
ms.date: 06/08/2017
ms.openlocfilehash: a7d1d0938d40cc4a196e7d33e341651edac867db
ms.sourcegitcommit: 1102fd44df64f18dc0561d0b3a7103ca81e74318
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 07/26/2017
---
# <a name="application-object-publisher"></a>Объект Application (издатель)

Представляет приложение Microsoft Publisher. Объект **приложения** включает в себя свойства и методы, возвращающие объекты верхнего уровня. Например свойство **ActiveDocument** возвращает объект **Document** .


## <a name="remarks"></a>Заметки

При использовании Microsoft Visual Basic для приложений в приложении Publisher, можно использовать все свойства и методы объекта **Application** , без описатель объекта **приложения** . Например, вместо ввода `Application.ActiveDocument.PrintOut`, можно ввести `ActiveDocument.PrintOut`. Свойства и методы, которые могут использоваться без описатель объекта **приложения** считаются «глобальная». Чтобы просмотреть глобальные свойства и методы в обозревателе объектов, нажмите кнопку **<globals>** в верхней части списка в поле **классы** . При доступе к объектной модели Publisher из проекта не является издателем, все свойства и методы должно быть полным.


## <a name="example"></a>Пример

Свойство **[приложения](http://msdn.microsoft.com/library/f3ed5997-b8ef-4729-4537-ae21424d2007%28Office.15%29.aspx)** используется для возврата объекта **приложения** . В следующем примере отображается имя приложения.
...
|[Завершите работу](http://msdn.microsoft.com/library/79948040-4848-b8e7-a70c-d23c1f416bac%28Office.15%29.aspx)|
...
|[Справка](http://msdn.microsoft.com/library/37b51399-5897-4003-a0a9-9829a8adf8ed%28Office.15%29.aspx)|
|[InchesToPoints не была назначена](http://msdn.microsoft.com/library/32c8740f-ad14-c947-b960-500378a5873d%28Office.15%29.aspx)|
...
|[Открыть](http://msdn.microsoft.com/library/560ac406-f058-8fd8-4b6d-978ff369de9b%28Office.15%29.aspx)|
...
|[Завершите работу](http://msdn.microsoft.com/library/db5a02ec-e553-6de1-0e2c-4a9a512e68fe%28Office.15%29.aspx)|
...
|[Приложения](http://msdn.microsoft.com/library/f3ed5997-b8ef-4729-4537-ae21424d2007%28Office.15%29.aspx)|
|[Помощник](http://msdn.microsoft.com/library/2abac248-bec5-876f-9ae5-88a59ce16b59%28Office.15%29.aspx)|
|[БезопасностьПрограммированияОбъектов](http://msdn.microsoft.com/library/610f6300-0335-4fa1-7574-14afcf0e96e6%28Office.15%29.aspx)|
|[Построение](http://msdn.microsoft.com/library/e0d4bb8e-5185-3d3c-fd80-c1e3c3902b2c%28Office.15%29.aspx)|
...
|[Документы](http://msdn.microsoft.com/library/dd48d68f-a6ae-b5c0-2a85-90abff1e6c5a%28Office.15%29.aspx)|
|[Классов FileDialog](http://msdn.microsoft.com/library/65d73a9d-be4c-d809-d10d-468181ef9eb0%28Office.15%29.aspx)|
...
|[Параметры](http://msdn.microsoft.com/library/999f208a-02e6-49fb-c9a0-42aa97c5e37e%28Office.15%29.aspx)|
|[Родительский раздел](http://msdn.microsoft.com/library/cab07b56-4c25-7309-5c06-bead2d5f691b%28Office.15%29.aspx)|
|[Путь](http://msdn.microsoft.com/library/36ac9a9c-8235-aeba-c3d5-d39aef960cc5%28Office.15%29.aspx)|
...
|[Код продукта](http://msdn.microsoft.com/library/aacd5ff6-dad1-af86-f4e0-af9012ae93f8%28Office.15%29.aspx)|
|[Свойство ScreenUpdating](http://msdn.microsoft.com/library/d265b4fb-1452-91a5-32fe-0cad54c8f29c%28Office.15%29.aspx)|
|[Выбор](http://msdn.microsoft.com/library/b4a542a7-cb54-476b-9ccf-004ce4b9ec47%28Office.15%29.aspx)|
...
|[Версия](http://msdn.microsoft.com/library/ffec5bca-cd81-77c6-d80b-e629abfa6dec%28Office.15%29.aspx)|
...
[Члены объекта приложения](http://msdn.microsoft.com/library/aa4d515b-f779-b8b5-968a-8e5f7466fb56%28Office.15%29.aspx)
