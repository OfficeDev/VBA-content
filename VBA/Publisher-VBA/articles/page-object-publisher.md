...
ms.date: 06/08/2017
ms.openlocfilehash: 09e1b56dca2b7a44d061906d36e112965266aeb4
ms.sourcegitcommit: 1102fd44df64f18dc0561d0b3a7103ca81e74318
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 07/26/2017
---
# <a name="page-object-publisher"></a>Объект Page (издатель)

Представляет страницы в публикации. Коллекция **[Pages](http://msdn.microsoft.com/library/d6b7262c-015c-dcf3-bff4-0091dd32b78f%28Office.15%29.aspx)** содержит все объекты **страницы** в публикации.


## <a name="example"></a>Пример

Используйте **страниц** (индекс), чтобы получить объект **страницы** . Следующий пример добавляет новый текст на первую фигуру на первой странице в активной публикации.
...
Используйте свойство **[FindBypageID](http://msdn.microsoft.com/library/23ff5e69-33b1-e394-9d09-7199eae19fe9%28Office.15%29.aspx)** найдите объект **Page** , с помощью идентификатора приложения назначенные страницы. Используйте метод **[Add](http://msdn.microsoft.com/library/3c22aa15-c1dc-94c8-62d6-a1bc9635cd89%28Office.15%29.aspx)** для создания новой страницы и добавить его в публикации. В следующем примере добавляет новую страницу в активной публикации и затем выполняет поиск этой страницы с помощью код страницы.
...
|[Дублирующиеся](http://msdn.microsoft.com/library/9ef9d493-d2ca-8cac-3cce-6f0878acb288%28Office.15%29.aspx)|
|[ExportEmailHTML](http://msdn.microsoft.com/library/6257e9b5-26b5-73ae-7d40-50dd0a764488%28Office.15%29.aspx)|
|[Перемещение](http://msdn.microsoft.com/library/754cfe41-0853-a2cf-59ee-85db68fb871a%28Office.15%29.aspx)|
...
|**Name**|
|:-----|
|[Приложения](http://msdn.microsoft.com/library/c5d05664-e1ea-7936-4d3d-3d813ff4ec45%28Office.15%29.aspx)|
|[Фон](http://msdn.microsoft.com/library/1bba32dc-0e7e-40ca-0f29-b67be6be518d%28Office.15%29.aspx)|
|[Нижний колонтитул](http://msdn.microsoft.com/library/8ab5a59b-c8d5-6217-098c-c53336ee5311%28Office.15%29.aspx)|
|[Заголовок](http://msdn.microsoft.com/library/f10806eb-972a-d482-935c-95d5ccbbbb36%28Office.15%29.aspx)|
|[Высота](http://msdn.microsoft.com/library/7ab931d7-c4aa-4687-44f8-2d03a389cd4f%28Office.15%29.aspx)|
...
|[Образец](http://msdn.microsoft.com/library/f206b4f1-cde3-458d-f26c-a970ad3bd21b%28Office.15%29.aspx)|
...
|[Родительский раздел](http://msdn.microsoft.com/library/908daa24-3b8b-6107-d6ce-6498e6964e8e%28Office.15%29.aspx)|
...
|[Фигур](http://msdn.microsoft.com/library/4e48d4cf-d7b6-9099-ddee-46a79e7eb7bf%28Office.15%29.aspx)|
|[Теги](http://msdn.microsoft.com/library/94a8be36-20c2-65bc-b1e2-41f24703b264%28Office.15%29.aspx)|
|[WebPageOptions](http://msdn.microsoft.com/library/c2e3ee01-5b49-e83c-a68b-a4d526da0215%28Office.15%29.aspx)|
|[Ширина](http://msdn.microsoft.com/library/cb86988c-4460-4adb-19ad-e336fa9d4316%28Office.15%29.aspx)|
|[Мастер](http://msdn.microsoft.com/library/05cf1482-bde5-9ea2-4099-69a56a2dc61a%28Office.15%29.aspx)|
