...
<a name="sectionSection0"> </a>
 ...
 _expression_. **SynchronizeWithSite**(SiteURL, ListName)
...
|:-----|:-----|:-----|:-----|
|SiteURL|Optional| **String**|URL of the SharePoint site.|
|ListName|Optional| **String**|Name of the tasks list. For a local project, Project Professional creates the tasks list if it does not exist.|
