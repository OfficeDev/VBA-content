...
| _Screen_|Optional|**Long**|A constant specifying the view to display. Can be one of the  **[PjViewScreen](a345e016-ef13-0605-7b2a-5e91c748743e.md)** constants. The default value is **pjGantt**|
