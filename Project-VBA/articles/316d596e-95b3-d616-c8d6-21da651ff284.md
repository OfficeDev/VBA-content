...
| _ImportMethod_|Optional|**Long**|The method to use when importing data. Can be one of the  **[PjImportMethods](9e2787b4-48c3-7257-d737-8eae6abca873.md)** constants. The default value is **pjImportNew**.|
...
| _TextFileOrigin_|Optional|**Long**|Specifies the character set under which a text file was created. Can be one of the following  **[PjTextFileOrigin](62ac1564-3ddc-9634-d710-668d66079f51.md)** constants: **pjTextOriginWin**, **pjTextOriginDOS**, **pjTextOriginUnicode**, or **pjTextOriginMac**.|
