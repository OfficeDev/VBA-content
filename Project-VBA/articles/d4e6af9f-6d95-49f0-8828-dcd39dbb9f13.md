...
|:-----|:-----|:-----|:-----|
| _Field_|Required|**Long**|The name of the table field. Can be one of the  **[PjField](f0df0929-921c-1f33-ab42-192efdaeb64d.md)** constants.|
| _AlignData_|Optional|**Long**|The alignment of the table data. Can be one of the  **[PjAlignment](925376b3-c8aa-3326-5693-71dd3510f28c.md)** constants. The default value is **pjRight**.|
