...
| _Items_|Optional|**[PjCompareVersionItems](1d5a4372-259c-2bd1-e967-bcab2485950f.md)**|Specifies the type of items to compare.|
| _Columns_|Optional|**[PjCompareVersionColumns](ae18b349-d77d-b292-306b-357b99acaefe.md)**|Specifies whether to show only column data, only column differences, or both differences and data.|
