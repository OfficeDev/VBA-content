...
| _Type_|Optional|**Long**|The type of relationship between the linked tasks. Can be one of the  **[PjTaskLinkType](141a1145-0eb5-3664-4755-394584aec8ac.md)** constants. The default value is **pjFinishToStart**.|
