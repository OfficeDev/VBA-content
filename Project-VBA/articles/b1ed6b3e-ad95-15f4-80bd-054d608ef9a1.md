...
|:-----|:-----|:-----|:-----|
|Name|Optional| **String**|Name of the copy of the view.|
|ApplyTo|Optional| **Integer**|Specifies which pane of a split view is copied. The value can be one of the following:
