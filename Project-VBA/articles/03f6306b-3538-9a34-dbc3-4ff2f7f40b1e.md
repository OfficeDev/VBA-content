...
| _ScaleOption_|Optional|**Long**|Specifies how to treat a picture of the active view if it is larger than  **MaxImageWidth** by **MaxImageHeight** (default 22 inches by 22 inches). The default value is **pjCopyPictureKeepRange**. Can be one of the **[PjCopyPictureScaleOption](c9b995a6-67a4-93bb-6ed0-1a5f738db537.md)** constants.|
...
| _MeasurementUnits_|Optional|**Variant**|**Long**. Specifies the units of measurement. The default value is **pjInches**. Can be one of the **[PjMeasurementUnits](8e6d4b6b-b94c-b4a0-b922-d36564e32c88.md)** constants.|
