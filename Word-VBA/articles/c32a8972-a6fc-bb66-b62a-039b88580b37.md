 ...
 **In this article**
 [Understanding Building Blocks](#sectionSection0)
 [Simple Tasks](#sectionSection1)
 [Creating a Custom Building Block](#sectionSection2)
 [Adding a New Category](#sectionSection3)
 [Accessing an Existing Building Block](#sectionSection4)
 [Inserting a Building Block into a Document](#sectionSection5)
 [Filtering a List of Building Blocks in a Content Control](#sectionSection6)
...
|**Name**|**Description**|
|:-----|:-----|
| ** [BuildingBlock](2558b89f-8552-bb71-fa40-101cab2635ba.md)**|A specific building block entry.|
| ** [BuildingBlocks](be5bba4a-b06c-0074-20bd-bbeb40e03d1c.md)**|A collection of building block entries in a template that are of the same type and category.|
| ** [BuildingBlockEntries](9c5946e9-947d-7284-ab16-b570bf7f0ff3.md)**|A collection of all the building blocks in a template.|
| ** [BuildingBlockType](e4f971da-f052-b6a2-db40-2f4cd0cfd6be.md)**|A building block type. |
| ** [BuildingBlockTypes](fb179437-b736-dd99-3aea-125346aa7a3d.md)**|A collection of building block types.|
| ** [Category](5485ae39-fbcf-b18f-b1f9-945e220ecd2a.md)**|A building block category.|
| ** [Categories](f5f5081d-4309-6617-28da-c369c1fe690c.md)**|A collection of building block categories.|

## Understanding Building Blocks
<a name="sectionSection0"> </a>

Building blocks are organized by type and category. Building block types are composed of a limited number of  ** [WdBuildingBlockTypes](be7fcedb-04fd-f27d-8f36-3120ca263f06.md)** constants. Although there are a limited number of these constants, that number is not small. There are 35 different **WdBuildingBlockTypes** constants. These types help you to define and organize your building blocks and, although you cannot create additional building block types, you can create an unlimited number of categories for each type.
...
However, building block are also programmable. You can create new building blocks, delete building blocks, and manage building blocks programmatically. You can also watch for when users insert new building blocks into a document by using the  ** [BuildingBlockInsert](6c4b1f1f-da22-63b9-a3d9-21d7bedb4b5b.md)** event. Plus, you can use building blocks with content controls to give you even greater control over which building blocks users can insert into their documents. For example, you can use a building block content control to filter the types of building blocks that a user sees, which means that the user cannot insert a building block into a document that is not allowed at a specific place in the document. There are several examples in the following sections that show you how to use the building block objects to work with building blocks programmatically.
...
The following code example assumes that there is at least one content control in the document. If the content control is a building block content control, the list of building blocks displayed in the building block list in the content control header includes only those added by using the AddCustomBuildingBlock subroutine shown earlier in this topic. For more information about content controls, see  [Working with Content Controls](b4092c71-a383-f1db-8d68-de69e8d8a86b.md).
