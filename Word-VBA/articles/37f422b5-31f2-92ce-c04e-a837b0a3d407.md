...
|:-----|:-----|:-----|:-----|
| _Type_|Optional| **Variant**|The axis to return. Can be one of the following  **[XlAxisType](f02ed77e-8315-f318-ded2-751bc72d19fc.md)** constants: **xlValue** , **xlCategory** , or **xlSeriesAxis** ( **xlSeriesAxis** is valid only for 3-D charts).|
| _AxisGroup_|Optional| **[XlAxisGroup](ed3ff1ce-28de-165d-bbfa-f3d770f32522.md)**|One of the enumeration values that specifies the axis group. The default is  **xlPrimary** .
