...
|:-----|:-----|:-----|:-----|
| _Type_|Optional| **[WdContentControlType](6bf57b23-d12f-b942-4a30-cd1deed09407.md)**|Specifies the type of content control to insert into the active document. If omitted, Microsoft Word inserts a rich-text content control.|
