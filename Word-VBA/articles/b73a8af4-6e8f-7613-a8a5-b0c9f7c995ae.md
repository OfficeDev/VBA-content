...
|:-----|:-----|
| **Borders**,  **Color**, or  **Shading**|A number â€” specified as text â€” corresponding to the position of the setting selected in the list box that contains values, where 0 (zero) is the first item, 1 is the second item, and so on|
| **Columns**|A number between 1 and 45 â€” specified as text â€” corresponding to the number of columns you want to apply|
