...
| _Format_|Optional| **Variant**|The file converter to be used to open the document. Can be one of the  **WdOpenFormat** constants. The default value is **wdOpenFormatAuto** .|
| _Format_|Required| **Variant**|The file converter to be used to open the document. Can be one of the following  **WdOpenFormat** constants. To specify an external file format, apply the **OpenFormat** property to a **FileConverter** object to determine the value to use with this argument.|
