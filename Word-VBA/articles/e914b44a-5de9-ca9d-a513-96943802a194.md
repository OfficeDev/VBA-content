...
|:-----|:-----|:-----|:-----|
| _Name_|Required| **Variant**|Specifies the name of the default chart template that Word uses when it creates new charts. This name can be set to either the name of a user-defined chart template in the gallery or a special  **[XlChartGallery](28187e1c-ae42-f666-abb6-775c368d3691.md)** constant, **xlBuiltIn** , to specify a built-in chart template.|
