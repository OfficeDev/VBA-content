...
|:-----|:-----|:-----|:-----|
| _Source_|Required| **Variant**|The new data as a string representation of a range contained in the  **[Workbook](2295d653-7a36-b258-dfb8-f48844331705.md)** property of the **[ChartData](323ee62c-9b70-8280-d448-79cf4d2b6953.md)** object for the chart.|
| _Rowcol_|Optional| **[XlRowCol](d9c9303d-155f-155c-6012-c7df2e1e47e4.md)**|One of the enumeration values that specifies whether the new values are in the rows or columns of the specified range.|
