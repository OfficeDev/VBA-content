...
|:-----|:-----|:-----|:-----|
|siglnimg|Required| **SignatureLineImage**|Contains the name if the signature line graphic.|
|psigsetup|Required| **SignatureSetup**|Specifies initial settings of the signature provider add-in.|
|psiginfo|Required| **SignatureInfo**|Specifies information about the signature provider add-in.|
