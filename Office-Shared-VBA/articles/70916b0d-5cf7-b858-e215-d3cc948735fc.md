...
## Syntax
 ...
 _expression_ Required. A variable that represents a **[SharedWorkspaceFolders](a9020edc-f199-6bab-75d1-c2bdc2a547d3.md)** object. The specified **SharedWorkspaceFolders** collection.
