...
|Type|Optional| **Variant**|The data type of the [Type](a6a18498-7a71-b2fb-f037-195bddd70573.md) property. Can be one of the following  **MsoDocProperties** constants: **msoPropertyTypeBoolean**,  **msoPropertyTypeDate**,  **msoPropertyTypeFloat**,  **msoPropertyTypeNumber**, or  **msoPropertyTypeString**.|
