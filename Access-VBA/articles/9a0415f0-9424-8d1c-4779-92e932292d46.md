...
These transaction methods manage transaction processing within a [Connection](c16023aa-0321-2513-ee71-255d6ffba03d.md) object as follows:
...
<a name="sectionSection1"> </a>
 ...
 _level_ = _object_. **BeginTrans**()

 _object_. **BeginTrans**

 _object_. **CommitTrans**

 _object_. **RollbackTrans**
