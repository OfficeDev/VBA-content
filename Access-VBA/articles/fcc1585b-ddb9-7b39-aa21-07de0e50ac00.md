...
Returns or sets a  **String** indicating which macro, event procedure, or user-defined function runs when the ** [AfterDelConfirm](49f6f575-6f67-08b0-a2aa-913c8182cbe9.md)**event occurs. Read/write.
