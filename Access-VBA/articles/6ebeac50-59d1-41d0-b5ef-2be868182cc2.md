...
This example uses the [Supports](2b4062ce-44df-4e84-1ce9-d6618c10c2af.md) method to display the options supported by a recordset opened with different cursor types. The DisplaySupport procedure is required for this procedure to run.
