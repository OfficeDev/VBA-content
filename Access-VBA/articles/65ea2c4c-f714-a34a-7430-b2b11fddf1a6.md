...
The following examples set a form's  ** [Filter](265F3397-3DC9-21B3-EBAC-55FB4E1261C0.md)** or ** [ServerFilter](18385DE5-BC0D-9D2C-F97C-5B42E3689B45.md)** property based on criteria that come from a control named HireDate that is on the form. Note the placement of the number signs.
