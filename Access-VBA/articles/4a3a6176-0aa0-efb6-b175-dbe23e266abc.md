...
In an ODBCDirect workspace, you can open a  **[Recordset](9774232c-e6da-175b-fc7f-ed2ab7908fa0.md)** containing more than one select query in the _source_ argument of **OpenRecordset**, or the **[SQL](16446789-c8be-bff0-eddd-b5f6a8530128.md)** property of a select query **[QueryDef](0b3d901c-345d-42a2-f5f1-fb09cc562e27.md)** object, as in the following example.
