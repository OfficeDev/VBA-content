...
|:-----|:-----|:-----|:-----|
|Action|Required| **AcSysCmdAction**|A  ** [AcSysCmdAction](a2879d50-9845-40b0-9e51-a022340c664b.md)** constant that identifies the type of action to take. This set of constants applies to a progress meter. The **SysCmd** method returns a **null** if these actions are successful. Otherwise, Microsoft Access generates a run-time error.|
 ...
 **Note**  When you specify the  **acSysCmdGetObjectState** value for the Action parameter, then you must specify the appropriate ** [AcObjectType](157a8d35-2b27-4f62-8e74-525043f6ec71.md)** constant.
