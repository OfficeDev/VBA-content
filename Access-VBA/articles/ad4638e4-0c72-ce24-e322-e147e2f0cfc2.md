...
You can use the  **DBEngine** property in[Visual Basic](http://msdn.microsoft.com/library/3fa3677b-a779-3bc7-0f0f-827c252b3292%28Office.15%29.aspx)to access the current  **DBEngine** object and its related properties. Read-only **DBEngine** .
