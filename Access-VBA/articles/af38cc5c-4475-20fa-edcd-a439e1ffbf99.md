...
This example demonstrates the [GetObjectOwner](716dd49a-8663-3f7a-32a3-0be353aea506.md) and[SetObjectOwner](http://msdn.microsoft.com/library/22c5d2d9-c7b2-3c3a-0b1f-a2e5bc46395c%28Office.15%29.aspx) methods. This code assumes the existence of the group Accounting (see the[Groups and Users Append, ChangePassword Methods Example (VC++)](4eaaed4f-f5bf-38d0-b984-8e3f344923c5.md) to see how to add this group to the system). The owner of the Categories table is set to Accounting.
