...
|:-----|:-----|:-----|:-----|
| _ObjectType_|Required|**AcOutputObjectType**|An [AcOutputObjectType](07352409-f01a-84d0-495d-87c318223e5c.md) constant that specifies the type of object to output.|
...
| _OutputQuality_|Optional|**AcExportQuality**|An  **[AcExportQuality](7b7f427e-4690-9689-d428-ed469cec920a.md)** constant that specifies the type of output device to optimize for. The default value is **acExportQualityPrint**.|
