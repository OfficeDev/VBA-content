...
|:-----|:-----|:-----|:-----|
|Cancel|Required| **Integer**|The setting determines if the  **DblClick** event occurs. Setting theCancel argument to **True** (-1) cancels the **DblClick** event.|
