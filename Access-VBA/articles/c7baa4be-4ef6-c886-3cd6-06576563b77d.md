...
| _ImportOptions_|Optional|**AcImportXMLOption**|An [AcImportXMLOption](f51b40cc-b8bb-addd-2bc6-5a0300e2cc2a.md) constant that specifies the option to use when importing XML files. The default value is **acStructureAndData**.|
