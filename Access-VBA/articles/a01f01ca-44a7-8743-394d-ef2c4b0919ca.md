...
To exercise the example, add a new record in the HTML form. Click  **Add New**. See the[Delete Method Example](aa647263-334b-152b-1d5e-2abe57bd7d73.md) to remove unwanted records.
