...
Modules can be sent only in MS-DOS Text format, so if you specify  **acSendModule** for theObjectType argument, you must specify **acFormatTXT** for theOutputFormat argument.
