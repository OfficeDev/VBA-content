...
|Show|Optional| **AcShowToolbar**| An [AcShowToolbar](b8546ec8-fd58-a2b7-24a0-ee678bfa3f33.md) constant that specifies whether to display or hide the toolbar and in which views to display or hide it. The default value is **acToolbarYes**.|
