...
|DatabaseType|Optional| **Variant**|A string expression that is the name of one of the types of databases that you can use to import, export, or link data. The DatatbaseType parameter is required for exporting and link data actions but not required for importing actions. The types or databases are:
