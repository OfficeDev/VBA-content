...
<a name="sectionSection0"> </a>
 ...
 Each **Name** object represents a defined name for a range of cells. Names can be either built-in namesâ€”such as Database, Print_Area, and Auto_Openâ€”or custom names.
