...
As explained above it is usually created entering the name into the name box to the left end of the formula bar. Note no spaces are allowed in the name.  
