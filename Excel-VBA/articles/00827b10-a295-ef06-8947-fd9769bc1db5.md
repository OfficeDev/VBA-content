...
- If pr â‰¤ 0, TBILLYIELD returns the #NUM! error value.
    
- If settlement â‰¥ maturity, or if maturity is more than one year after settlement, TBILLYIELD returns the #NUM! error value.
