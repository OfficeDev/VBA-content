...
Returns a  [Range](b8207778-0dcc-4570-1234-f130532cc8cd.md) object that represents the rectangular intersection of two or more range objects within the same worksheet. If one or more ranges from a different worksheet are specified, an error will be returned. 
