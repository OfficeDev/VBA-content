...
| _ElementID_|Required| **Long**|When the method returns, this argument contains the  **[XLChartItem](34a85683-2693-10b3-cdb2-e40e123071ad.md)** value of the chart element at the specified coordinates. For more information, see the ?Remarks? section.|
